...
class HCAnnotationsOptions implements HCOption {
  const HCAnnotationsOptions({
    this.animation,
    this.className,
  ...
  final HCAnnotationsEventsOptions? events;
  ...
  final HCAnnotationsTypeOptions? typeOptions;

  /// (Highstock) Option override for specific advanced annotation types. This
  final HCAnnotationsTypesOptions? types;
