...
class HCAnnotationsTypesCrookedLineOptions implements HCOption {
  const HCAnnotationsTypesCrookedLineOptions({
  ...
  final HCAnnotationsTypesCrookedLineLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesCrookedLineTypeOptions? typeOptions;
