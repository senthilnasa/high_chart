...
class HCAnnotationsTypesElliottWaveOptions implements HCOption {
  const HCAnnotationsTypesElliottWaveOptions({
  ...
  final HCAnnotationsTypesElliottWaveLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesElliottWaveTypeOptions? typeOptions;
