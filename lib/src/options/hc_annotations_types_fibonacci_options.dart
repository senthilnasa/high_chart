...
class HCAnnotationsTypesFibonacciOptions implements HCOption {
  const HCAnnotationsTypesFibonacciOptions({
  ...
  final HCAnnotationsTypesFibonacciLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesFibonacciTypeOptions? typeOptions;
