...
class HCAnnotationsTypesFibonacciTimeZonesOptions implements HCOption {
  const HCAnnotationsTypesFibonacciTimeZonesOptions({
  ...
  final HCAnnotationsTypesFibonacciTimeZonesLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesFibonacciTimeZonesTypeOptions? typeOptions;
