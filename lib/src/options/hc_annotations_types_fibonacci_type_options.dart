...
class HCAnnotationsTypesFibonacciTypeOptions implements HCOption {
  const HCAnnotationsTypesFibonacciTypeOptions({
  ...
  final List<HCAnnotationsTypesFibonacciTypeLabelsOptions>? labels;

  /// (Highstock) Line options.
  final HCAnnotationsTypesFibonacciTypeLineOptions? line;
  ...
  final List<HCAnnotationsTypesFibonacciTypePointsOptions>? points;
