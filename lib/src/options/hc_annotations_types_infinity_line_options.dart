...
class HCAnnotationsTypesInfinityLineOptions implements HCOption {
  const HCAnnotationsTypesInfinityLineOptions({
  ...
  final HCAnnotationsTypesInfinityLineLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesInfinityLineTypeOptions? typeOptions;
