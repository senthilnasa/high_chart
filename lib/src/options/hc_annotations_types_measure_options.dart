...
class HCAnnotationsTypesMeasureOptions implements HCOption {
  const HCAnnotationsTypesMeasureOptions({
  ...
  final HCAnnotationsTypesMeasureTypeOptions? typeOptions;
