...
class HCAnnotationsTypesPitchforkOptions implements HCOption {
  const HCAnnotationsTypesPitchforkOptions({
  ...
  final HCAnnotationsTypesPitchforkLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesPitchforkTypeOptions? typeOptions;
