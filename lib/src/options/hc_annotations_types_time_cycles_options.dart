...
class HCAnnotationsTypesTimeCyclesOptions implements HCOption {
  const HCAnnotationsTypesTimeCyclesOptions({
  ...
  final HCAnnotationsTypesTimeCyclesTypeOptions? typeOptions;
