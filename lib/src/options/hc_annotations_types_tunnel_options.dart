...
class HCAnnotationsTypesTunnelOptions implements HCOption {
  const HCAnnotationsTypesTunnelOptions({
  ...
  final HCAnnotationsTypesTunnelLabelOptions? labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCAnnotationsTypesTunnelTypeOptions? typeOptions;
