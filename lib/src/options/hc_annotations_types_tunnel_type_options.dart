...
class HCAnnotationsTypesTunnelTypeOptions implements HCOption {
  const HCAnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCAnnotationsTypesTunnelTypeLineOptions? line;

  final List<HCAnnotationsTypesTunnelTypePointsOptions>? points;
