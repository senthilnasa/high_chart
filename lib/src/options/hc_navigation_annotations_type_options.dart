...
class HCNavigationAnnotationsTypeOptions implements HCOption {
  const HCNavigationAnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
