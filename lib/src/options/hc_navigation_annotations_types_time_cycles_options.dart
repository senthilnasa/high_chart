...
class HCNavigationAnnotationsTypesTimeCyclesOptions implements HCOption {
  const HCNavigationAnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationAnnotationsTypesTimeCyclesTypeOptions? typeOptions;
