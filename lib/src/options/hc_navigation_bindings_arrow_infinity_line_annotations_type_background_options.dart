...
class HCNavigationBindingsArrowInfinityLineAnnotationsTypeBackgroundOptions
    implements HCOption {
  const HCNavigationBindingsArrowInfinityLineAnnotationsTypeBackgroundOptions({
    this.dashStyle,
    this.fill,
    this.height,
    this.r,
