...
class HCNavigationBindingsArrowInfinityLineAnnotationsTypesTunnelLabelOptions
    implements HCOption {
  const HCNavigationBindingsArrowInfinityLineAnnotationsTypesTunnelLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
