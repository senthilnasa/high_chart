...
class HCNavigationBindingsArrowInfinityLineAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsArrowInfinityLineAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
