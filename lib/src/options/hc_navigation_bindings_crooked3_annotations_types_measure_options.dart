...
class HCNavigationBindingsCrooked3AnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsCrooked3AnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsCrooked3AnnotationsTypesMeasureTypeOptions?
      typeOptions;
