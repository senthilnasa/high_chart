...
class HCNavigationBindingsCrooked5AnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsCrooked5AnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsCrooked5AnnotationsTypesMeasureTypeOptions?
      typeOptions;
