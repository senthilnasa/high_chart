...
class HCNavigationBindingsElliott3AnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsElliott3AnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsElliott3AnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott3AnnotationsTypesTunnelTypeOptions?
      typeOptions;
