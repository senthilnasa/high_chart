...
class HCNavigationBindingsElliott3AnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsElliott3AnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsElliott3AnnotationsTypesTunnelTypeLineOptions? line;

  final List<
          HCNavigationBindingsElliott3AnnotationsTypesTunnelTypePointsOptions>?
      points;
