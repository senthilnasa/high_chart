...
class HCNavigationBindingsElliott5AnnotationsOptions implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsOptions({
    this.animation,
    this.className,
  ...
  final HCNavigationBindingsElliott5AnnotationsEventsOptions? events;

  /// (Highstock) Sets an ID for an annotation. Can be user later when removing
  final dynamic id;

  /// (Highstock) Options for annotation's labels. Each label inherits options
  final HCNavigationBindingsElliott5AnnotationsLabelOptions? labelOptions;

  /// (Highstock) An array of labels for the annotation. For options that apply
  final List<HCNavigationBindingsElliott5AnnotationsLabelsOptions>? labels;

  /// (Highstock) Options for annotation's shapes. Each shape inherits options
  final HCNavigationBindingsElliott5AnnotationsShapeOptions? shapeOptions;

  /// (Highstock) An array of shapes for the annotation. For options that apply
  final List<HCNavigationBindingsElliott5AnnotationsShapesOptions>? shapes;

  /// (Highstock) For advanced annotations, this option defines the type of
  final String? type;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypeOptions? typeOptions;

  /// (Highstock) Option override for specific advanced annotation types. This
  final HCNavigationBindingsElliott5AnnotationsTypesOptions? types;
