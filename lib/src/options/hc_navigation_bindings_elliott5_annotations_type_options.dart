...
class HCNavigationBindingsElliott5AnnotationsTypeOptions implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
  ...
  final HCNavigationBindingsElliott5AnnotationsTypeBackgroundOptions?
      background;
  ...
  final HCNavigationBindingsElliott5AnnotationsTypeLineOptions? line;
