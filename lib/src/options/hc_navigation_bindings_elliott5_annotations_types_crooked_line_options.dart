...
class HCNavigationBindingsElliott5AnnotationsTypesCrookedLineOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesCrookedLineOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesCrookedLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypesCrookedLineTypeOptions?
      typeOptions;
