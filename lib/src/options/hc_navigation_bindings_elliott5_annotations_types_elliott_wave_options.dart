...
class HCNavigationBindingsElliott5AnnotationsTypesElliottWaveOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesElliottWaveOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesElliottWaveLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypesElliottWaveTypeOptions?
      typeOptions;
