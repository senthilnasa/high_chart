...
class HCNavigationBindingsElliott5AnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypesFibonacciTypeOptions?
      typeOptions;
