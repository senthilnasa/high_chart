...
class HCNavigationBindingsElliott5AnnotationsTypesFibonacciTimeZonesOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesFibonacciTimeZonesOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesFibonacciTimeZonesLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypesFibonacciTimeZonesTypeOptions?
      typeOptions;
