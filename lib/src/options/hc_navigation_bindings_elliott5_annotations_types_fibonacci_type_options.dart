...
class HCNavigationBindingsElliott5AnnotationsTypesFibonacciTypeOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesFibonacciTypeOptions({
  ...
  final List<
          HCNavigationBindingsElliott5AnnotationsTypesFibonacciTypeLabelsOptions>?
      labels;

  /// (Highstock) Line options.
  final HCNavigationBindingsElliott5AnnotationsTypesFibonacciTypeLineOptions?
      line;
  ...
  final List<
          HCNavigationBindingsElliott5AnnotationsTypesFibonacciTypePointsOptions>?
      points;
