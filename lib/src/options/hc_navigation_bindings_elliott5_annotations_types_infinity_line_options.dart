...
class HCNavigationBindingsElliott5AnnotationsTypesInfinityLineOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesInfinityLineOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesInfinityLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypesInfinityLineTypeOptions?
      typeOptions;
