...
class HCNavigationBindingsElliott5AnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesMeasureTypeOptions?
      typeOptions;
