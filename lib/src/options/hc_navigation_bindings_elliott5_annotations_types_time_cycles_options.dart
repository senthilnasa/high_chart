...
class HCNavigationBindingsElliott5AnnotationsTypesTimeCyclesOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesTimeCyclesTypeOptions?
      typeOptions;
