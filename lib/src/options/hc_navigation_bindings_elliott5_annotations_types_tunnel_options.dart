...
class HCNavigationBindingsElliott5AnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsElliott5AnnotationsTypesTunnelTypeOptions?
      typeOptions;
