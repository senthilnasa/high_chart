...
class HCNavigationBindingsElliott5AnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsElliott5AnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsElliott5AnnotationsTypesTunnelTypeLineOptions? line;

  final List<
          HCNavigationBindingsElliott5AnnotationsTypesTunnelTypePointsOptions>?
      points;
