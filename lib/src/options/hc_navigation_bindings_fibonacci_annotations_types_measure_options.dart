...
class HCNavigationBindingsFibonacciAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsFibonacciAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsFibonacciAnnotationsTypesMeasureTypeOptions?
      typeOptions;
