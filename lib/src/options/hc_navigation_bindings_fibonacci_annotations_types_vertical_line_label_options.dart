...
class HCNavigationBindingsFibonacciAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsFibonacciAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
