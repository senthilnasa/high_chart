...
class HCNavigationBindingsHorizontalLineAnnotationsTypesElliottWaveOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesElliottWaveOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesElliottWaveLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsHorizontalLineAnnotationsTypesElliottWaveTypeOptions?
      typeOptions;
