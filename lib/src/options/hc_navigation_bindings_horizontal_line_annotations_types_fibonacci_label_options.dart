...
class HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciLabelOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
