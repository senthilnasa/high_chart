...
class HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciTypeOptions?
      typeOptions;
