...
class HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciTypeOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciTypeOptions({
  ...
  final List<
          HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciTypeLabelsOptions>?
      labels;

  /// (Highstock) Line options.
  final HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciTypeLineOptions?
      line;
  ...
  final List<
          HCNavigationBindingsHorizontalLineAnnotationsTypesFibonacciTypePointsOptions>?
      points;
