...
class HCNavigationBindingsHorizontalLineAnnotationsTypesInfinityLineOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesInfinityLineOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesInfinityLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsHorizontalLineAnnotationsTypesInfinityLineTypeOptions?
      typeOptions;
