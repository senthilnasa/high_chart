...
class HCNavigationBindingsHorizontalLineAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesMeasureTypeOptions?
      typeOptions;
