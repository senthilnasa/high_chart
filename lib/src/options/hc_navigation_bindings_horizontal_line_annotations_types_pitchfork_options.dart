...
class HCNavigationBindingsHorizontalLineAnnotationsTypesPitchforkOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesPitchforkOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesPitchforkLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsHorizontalLineAnnotationsTypesPitchforkTypeOptions?
      typeOptions;
