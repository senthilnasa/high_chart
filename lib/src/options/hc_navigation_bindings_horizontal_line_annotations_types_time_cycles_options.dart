...
class HCNavigationBindingsHorizontalLineAnnotationsTypesTimeCyclesOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesTimeCyclesTypeOptions?
      typeOptions;
