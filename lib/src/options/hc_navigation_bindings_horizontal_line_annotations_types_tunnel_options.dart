...
class HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelTypeOptions?
      typeOptions;
