...
class HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelTypeLineOptions?
      line;

  final List<
          HCNavigationBindingsHorizontalLineAnnotationsTypesTunnelTypePointsOptions>?
      points;
