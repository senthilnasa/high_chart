...
class HCNavigationBindingsHorizontalLineAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsHorizontalLineAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
