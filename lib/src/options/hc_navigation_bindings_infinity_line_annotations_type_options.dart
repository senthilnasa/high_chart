...
class HCNavigationBindingsInfinityLineAnnotationsTypeOptions
    implements HCOption {
  const HCNavigationBindingsInfinityLineAnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
  ...
  final HCNavigationBindingsInfinityLineAnnotationsTypeBackgroundOptions?
      background;
  ...
  final HCNavigationBindingsInfinityLineAnnotationsTypeLineOptions? line;
