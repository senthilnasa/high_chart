...
class HCNavigationBindingsInfinityLineAnnotationsTypesCrookedLineOptions
    implements HCOption {
  const HCNavigationBindingsInfinityLineAnnotationsTypesCrookedLineOptions({
  ...
  final HCNavigationBindingsInfinityLineAnnotationsTypesCrookedLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsInfinityLineAnnotationsTypesCrookedLineTypeOptions?
      typeOptions;
