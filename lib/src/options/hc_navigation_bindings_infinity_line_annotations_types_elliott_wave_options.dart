...
class HCNavigationBindingsInfinityLineAnnotationsTypesElliottWaveOptions
    implements HCOption {
  const HCNavigationBindingsInfinityLineAnnotationsTypesElliottWaveOptions({
  ...
  final HCNavigationBindingsInfinityLineAnnotationsTypesElliottWaveLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsInfinityLineAnnotationsTypesElliottWaveTypeOptions?
      typeOptions;
