...
class HCNavigationBindingsInfinityLineAnnotationsTypesFibonacciLabelOptions
    implements HCOption {
  const HCNavigationBindingsInfinityLineAnnotationsTypesFibonacciLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
