...
class HCNavigationBindingsInfinityLineAnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsInfinityLineAnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsInfinityLineAnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsInfinityLineAnnotationsTypesFibonacciTypeOptions?
      typeOptions;
