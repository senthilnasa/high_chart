...
class HCNavigationBindingsInfinityLineAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsInfinityLineAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
