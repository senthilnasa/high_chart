...
class HCNavigationBindingsMeasureXAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsMeasureXAnnotationsTypesMeasureTypeOptions?
      typeOptions;
