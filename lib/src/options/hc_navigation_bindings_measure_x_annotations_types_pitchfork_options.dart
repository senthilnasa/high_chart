...
class HCNavigationBindingsMeasureXAnnotationsTypesPitchforkOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXAnnotationsTypesPitchforkOptions({
  ...
  final HCNavigationBindingsMeasureXAnnotationsTypesPitchforkLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXAnnotationsTypesPitchforkTypeOptions?
      typeOptions;
