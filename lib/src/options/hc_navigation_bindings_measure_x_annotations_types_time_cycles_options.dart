...
class HCNavigationBindingsMeasureXAnnotationsTypesTimeCyclesOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXAnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationBindingsMeasureXAnnotationsTypesTimeCyclesTypeOptions?
      typeOptions;
