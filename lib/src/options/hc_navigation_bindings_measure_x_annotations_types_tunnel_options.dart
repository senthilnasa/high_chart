...
class HCNavigationBindingsMeasureXAnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXAnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsMeasureXAnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXAnnotationsTypesTunnelTypeOptions?
      typeOptions;
