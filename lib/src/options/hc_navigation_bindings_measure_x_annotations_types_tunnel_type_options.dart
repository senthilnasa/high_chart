...
class HCNavigationBindingsMeasureXAnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXAnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsMeasureXAnnotationsTypesTunnelTypeLineOptions? line;

  final List<
          HCNavigationBindingsMeasureXAnnotationsTypesTunnelTypePointsOptions>?
      points;
