...
class HCNavigationBindingsMeasureXYAnnotationsTypeOptions implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypeBackgroundOptions?
      background;
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypeLineOptions? line;
