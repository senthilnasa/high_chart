...
class HCNavigationBindingsMeasureXYAnnotationsTypesCrookedLineOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesCrookedLineOptions({
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypesCrookedLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXYAnnotationsTypesCrookedLineTypeOptions?
      typeOptions;
