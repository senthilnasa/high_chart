...
class HCNavigationBindingsMeasureXYAnnotationsTypesElliottWaveOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesElliottWaveOptions({
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypesElliottWaveLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXYAnnotationsTypesElliottWaveTypeOptions?
      typeOptions;
