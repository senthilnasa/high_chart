...
class HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTypeOptions?
      typeOptions;
