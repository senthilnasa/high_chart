...
class HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTimeZonesOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTimeZonesOptions({
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTimeZonesLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTimeZonesTypeOptions?
      typeOptions;
