...
class HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTypeOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTypeOptions({
  ...
  final List<
          HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTypeLabelsOptions>?
      labels;

  /// (Highstock) Line options.
  final HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTypeLineOptions?
      line;
  ...
  final List<
          HCNavigationBindingsMeasureXYAnnotationsTypesFibonacciTypePointsOptions>?
      points;
