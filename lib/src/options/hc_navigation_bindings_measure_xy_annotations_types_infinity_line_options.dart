...
class HCNavigationBindingsMeasureXYAnnotationsTypesInfinityLineOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesInfinityLineOptions({
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypesInfinityLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsMeasureXYAnnotationsTypesInfinityLineTypeOptions?
      typeOptions;
