...
class HCNavigationBindingsMeasureXYAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsMeasureXYAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsMeasureXYAnnotationsTypesMeasureTypeOptions?
      typeOptions;
