...
class HCNavigationBindingsParallelChannelAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsParallelChannelAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
