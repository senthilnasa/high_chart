...
class HCNavigationBindingsPitchforkAnnotationsTypeOptions implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypeBackgroundOptions?
      background;
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypeLineOptions? line;
