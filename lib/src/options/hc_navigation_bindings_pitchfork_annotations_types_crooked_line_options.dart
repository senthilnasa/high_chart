...
class HCNavigationBindingsPitchforkAnnotationsTypesCrookedLineOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesCrookedLineOptions({
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesCrookedLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsPitchforkAnnotationsTypesCrookedLineTypeOptions?
      typeOptions;
