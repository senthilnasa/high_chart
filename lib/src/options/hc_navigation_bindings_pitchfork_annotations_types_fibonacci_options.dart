...
class HCNavigationBindingsPitchforkAnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsPitchforkAnnotationsTypesFibonacciTypeOptions?
      typeOptions;
