...
class HCNavigationBindingsPitchforkAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesMeasureTypeOptions?
      typeOptions;
