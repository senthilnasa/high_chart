...
class HCNavigationBindingsPitchforkAnnotationsTypesPitchforkOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesPitchforkOptions({
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesPitchforkLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsPitchforkAnnotationsTypesPitchforkTypeOptions?
      typeOptions;
