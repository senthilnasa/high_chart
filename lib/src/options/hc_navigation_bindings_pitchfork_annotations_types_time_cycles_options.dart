...
class HCNavigationBindingsPitchforkAnnotationsTypesTimeCyclesOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesTimeCyclesTypeOptions?
      typeOptions;
