...
class HCNavigationBindingsPitchforkAnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsPitchforkAnnotationsTypesTunnelTypeOptions?
      typeOptions;
