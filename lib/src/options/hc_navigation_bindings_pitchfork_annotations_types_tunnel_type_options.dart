...
class HCNavigationBindingsPitchforkAnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsPitchforkAnnotationsTypesTunnelTypeLineOptions?
      line;

  final List<
          HCNavigationBindingsPitchforkAnnotationsTypesTunnelTypePointsOptions>?
      points;
