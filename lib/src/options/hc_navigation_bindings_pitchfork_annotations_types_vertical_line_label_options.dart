...
class HCNavigationBindingsPitchforkAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsPitchforkAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
