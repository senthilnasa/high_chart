...
class HCNavigationBindingsVerticalArrowAnnotationsTypesFibonacciTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesFibonacciTypeOptions({
  ...
  final List<
          HCNavigationBindingsVerticalArrowAnnotationsTypesFibonacciTypeLabelsOptions>?
      labels;

  /// (Highstock) Line options.
  final HCNavigationBindingsVerticalArrowAnnotationsTypesFibonacciTypeLineOptions?
      line;
  ...
  final List<
          HCNavigationBindingsVerticalArrowAnnotationsTypesFibonacciTypePointsOptions>?
      points;
