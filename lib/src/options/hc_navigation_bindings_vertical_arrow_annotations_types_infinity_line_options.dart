...
class HCNavigationBindingsVerticalArrowAnnotationsTypesInfinityLineOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesInfinityLineOptions({
  ...
  final HCNavigationBindingsVerticalArrowAnnotationsTypesInfinityLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalArrowAnnotationsTypesInfinityLineTypeOptions?
      typeOptions;
