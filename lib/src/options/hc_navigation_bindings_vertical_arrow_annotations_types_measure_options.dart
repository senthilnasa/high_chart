...
class HCNavigationBindingsVerticalArrowAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsVerticalArrowAnnotationsTypesMeasureTypeOptions?
      typeOptions;
