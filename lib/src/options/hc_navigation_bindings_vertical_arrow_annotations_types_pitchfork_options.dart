...
class HCNavigationBindingsVerticalArrowAnnotationsTypesPitchforkOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesPitchforkOptions({
  ...
  final HCNavigationBindingsVerticalArrowAnnotationsTypesPitchforkLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalArrowAnnotationsTypesPitchforkTypeOptions?
      typeOptions;
