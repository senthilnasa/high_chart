...
class HCNavigationBindingsVerticalArrowAnnotationsTypesTimeCyclesOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationBindingsVerticalArrowAnnotationsTypesTimeCyclesTypeOptions?
      typeOptions;
