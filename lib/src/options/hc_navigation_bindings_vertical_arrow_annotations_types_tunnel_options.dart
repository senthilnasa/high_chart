...
class HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelTypeOptions?
      typeOptions;
