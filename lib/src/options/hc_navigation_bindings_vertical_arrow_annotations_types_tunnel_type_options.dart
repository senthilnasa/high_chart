...
class HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelTypeLineOptions?
      line;

  final List<
          HCNavigationBindingsVerticalArrowAnnotationsTypesTunnelTypePointsOptions>?
      points;
