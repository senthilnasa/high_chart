...
class HCNavigationBindingsVerticalArrowAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalArrowAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
