...
class HCNavigationBindingsVerticalCounterAnnotationsOptions
    implements HCOption {
  const HCNavigationBindingsVerticalCounterAnnotationsOptions({
    this.animation,
    this.className,
  ...
  final HCNavigationBindingsVerticalCounterAnnotationsEventsOptions? events;

  /// (Highstock) Sets an ID for an annotation. Can be user later when removing
  final dynamic id;

  /// (Highstock) Options for annotation's labels. Each label inherits options
  final HCNavigationBindingsVerticalCounterAnnotationsLabelOptions?
      labelOptions;

  /// (Highstock) An array of labels for the annotation. For options that apply
  final List<HCNavigationBindingsVerticalCounterAnnotationsLabelsOptions>?
      labels;

  /// (Highstock) Options for annotation's shapes. Each shape inherits options
  final HCNavigationBindingsVerticalCounterAnnotationsShapeOptions?
      shapeOptions;

  /// (Highstock) An array of shapes for the annotation. For options that apply
  final List<HCNavigationBindingsVerticalCounterAnnotationsShapesOptions>?
      shapes;
  ...
  final HCNavigationBindingsVerticalCounterAnnotationsTypeOptions? typeOptions;

  /// (Highstock) Option override for specific advanced annotation types. This
  final HCNavigationBindingsVerticalCounterAnnotationsTypesOptions? types;
