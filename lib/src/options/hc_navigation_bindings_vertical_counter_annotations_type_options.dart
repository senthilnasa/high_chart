...
class HCNavigationBindingsVerticalCounterAnnotationsTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalCounterAnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
  ...
  final HCNavigationBindingsVerticalCounterAnnotationsTypeBackgroundOptions?
      background;
  ...
  final HCNavigationBindingsVerticalCounterAnnotationsTypeLineOptions? line;
