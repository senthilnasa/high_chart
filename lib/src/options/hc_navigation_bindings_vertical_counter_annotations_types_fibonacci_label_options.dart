...
class HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciLabelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
