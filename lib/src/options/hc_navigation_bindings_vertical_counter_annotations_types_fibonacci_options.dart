...
class HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciTypeOptions?
      typeOptions;
