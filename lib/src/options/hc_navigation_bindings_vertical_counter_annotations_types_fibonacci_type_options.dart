...
class HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciTypeOptions({
  ...
  final List<
          HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciTypeLabelsOptions>?
      labels;

  /// (Highstock) Line options.
  final HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciTypeLineOptions?
      line;
  ...
  final List<
          HCNavigationBindingsVerticalCounterAnnotationsTypesFibonacciTypePointsOptions>?
      points;
