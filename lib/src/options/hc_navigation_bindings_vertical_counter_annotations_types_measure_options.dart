...
class HCNavigationBindingsVerticalCounterAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsVerticalCounterAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsVerticalCounterAnnotationsTypesMeasureTypeOptions?
      typeOptions;
