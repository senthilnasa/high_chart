...
class HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelTypeOptions?
      typeOptions;
