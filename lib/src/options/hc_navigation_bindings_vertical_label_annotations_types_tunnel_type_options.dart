...
class HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelTypeOptions({
    this.background,
    this.height,
  ...
  final HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelTypeLineOptions?
      line;

  final List<
          HCNavigationBindingsVerticalLabelAnnotationsTypesTunnelTypePointsOptions>?
      points;
