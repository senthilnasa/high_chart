...
class HCNavigationBindingsVerticalLabelAnnotationsTypesVerticalLineLabelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLabelAnnotationsTypesVerticalLineLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
