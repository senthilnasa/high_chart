...
class HCNavigationBindingsVerticalLineAnnotationsTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypeOptions({
    this.background,
    this.height,
    this.line,
    this.point,
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypeBackgroundOptions?
      background;
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypeLineOptions? line;
