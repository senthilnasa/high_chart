...
class HCNavigationBindingsVerticalLineAnnotationsTypesCrookedLineOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesCrookedLineOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesCrookedLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLineAnnotationsTypesCrookedLineTypeOptions?
      typeOptions;
