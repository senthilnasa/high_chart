...
class HCNavigationBindingsVerticalLineAnnotationsTypesElliottWaveOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesElliottWaveOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesElliottWaveLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLineAnnotationsTypesElliottWaveTypeOptions?
      typeOptions;
