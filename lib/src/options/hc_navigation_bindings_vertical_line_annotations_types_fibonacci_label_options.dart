...
class HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciLabelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciLabelOptions({
    this.accessibility,
    this.align,
    this.allowOverlap,
