...
class HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciTypeOptions?
      typeOptions;
