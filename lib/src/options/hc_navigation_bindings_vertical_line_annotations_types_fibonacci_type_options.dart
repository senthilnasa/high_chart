...
class HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciTypeOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciTypeOptions({
  ...
  final List<
          HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciTypeLabelsOptions>?
      labels;

  /// (Highstock) Line options.
  final HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciTypeLineOptions?
      line;
  ...
  final List<
          HCNavigationBindingsVerticalLineAnnotationsTypesFibonacciTypePointsOptions>?
      points;
