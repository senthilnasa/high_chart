...
class HCNavigationBindingsVerticalLineAnnotationsTypesInfinityLineOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesInfinityLineOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesInfinityLineLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLineAnnotationsTypesInfinityLineTypeOptions?
      typeOptions;
