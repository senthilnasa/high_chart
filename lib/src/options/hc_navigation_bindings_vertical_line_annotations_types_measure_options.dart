...
class HCNavigationBindingsVerticalLineAnnotationsTypesMeasureOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesMeasureOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesMeasureTypeOptions?
      typeOptions;
