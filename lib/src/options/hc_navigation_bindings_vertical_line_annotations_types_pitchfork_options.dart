...
class HCNavigationBindingsVerticalLineAnnotationsTypesPitchforkOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesPitchforkOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesPitchforkLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLineAnnotationsTypesPitchforkTypeOptions?
      typeOptions;
