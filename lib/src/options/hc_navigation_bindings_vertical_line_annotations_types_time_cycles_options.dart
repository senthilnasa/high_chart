...
class HCNavigationBindingsVerticalLineAnnotationsTypesTimeCyclesOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesTimeCyclesOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesTimeCyclesTypeOptions?
      typeOptions;
