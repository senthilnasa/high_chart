...
class HCNavigationBindingsVerticalLineAnnotationsTypesTunnelOptions
    implements HCOption {
  const HCNavigationBindingsVerticalLineAnnotationsTypesTunnelOptions({
  ...
  final HCNavigationBindingsVerticalLineAnnotationsTypesTunnelLabelOptions?
      labelOptions;

  /// (Highstock) Additional options for an annotation with the type.
  final HCNavigationBindingsVerticalLineAnnotationsTypesTunnelTypeOptions?
      typeOptions;
