...
class HCPlotLinearregressioninterceptOptions implements HCOption {
  const HCPlotLinearregressioninterceptOptions({
    this.accessibility,
  ...
  final HCPlotLinearregressioninterceptDataSortingOptions? dataSorting;
  ...
  final HCPlotLinearregressioninterceptParamsOptions? params;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotLinearregressioninterceptParamsOptions implements HCOption {
  const HCPlotLinearregressioninterceptParamsOptions({
    this.index,
    this.period,
    this.xAxisUnit,
  });
  ...
  /// (Highstock) Unit (in milliseconds) for the x axis distances used to compute the regression line parameters (slope & intercept) for every range. In Highcharts Stock the x axis values are always represented in milliseconds which may cause that distances between points are "big" integer numbers.
  final num? xAxisUnit;
...
class HCPlotLinearregressioninterceptStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotLinearregressioninterceptStatesInactiveAnimationOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLinearregressioninterceptStatesSelectAnimationOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotLinearregressioninterceptTooltipHeaderOptions implements HCOption {
  const HCPlotLinearregressioninterceptTooltipHeaderOptions({
...
class HCPlotLinearregressioninterceptTooltipPositionOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotLinearregressionslopeAccessibilityPointOptions implements HCOption {
  const HCPlotLinearregressionslopeAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
class HCPlotLinearregressionslopeDataLabelsAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionslopeDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotLinearregressionslopeDataLabelsOptions implements HCOption {
  const HCPlotLinearregressionslopeDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotLinearregressionslopeDataSortingOptions implements HCOption {
  const HCPlotLinearregressionslopeDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotLinearregressionslopeLabelStyleOptions implements HCOption {
...
class HCPlotLinearregressionslopeMarkerStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionslopeMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotLinearregressionslopeOnPointConnectorOptions implements HCOption {
  const HCPlotLinearregressionslopeOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotLinearregressionslopeOnPointOptions implements HCOption {
  const HCPlotLinearregressionslopeOnPointOptions({
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotLinearregressionslopeOnPointPositionOptions implements HCOption {
  const HCPlotLinearregressionslopeOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotLinearregressionslopeOptions implements HCOption {
  const HCPlotLinearregressionslopeOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotLinearregressionslopeDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Parameters used in calculation of regression series' points.
  final HCPlotLinearregressionslopeParamsOptions? params;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLinearregressionslopeStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionslopeStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotLinearregressionslopeStatesInactiveAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionslopeStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLinearregressionslopeStatesSelectAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionslopeStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotLinearregressionslopeTooltipHeaderOptions implements HCOption {
  const HCPlotLinearregressionslopeTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotLinearregressionslopeTooltipPositionOptions implements HCOption {
  const HCPlotLinearregressionslopeTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotLollipopAccessibilityPointOptions implements HCOption {
  const HCPlotLollipopAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotLollipopDataSortingOptions implements HCOption {
  const HCPlotLollipopDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotLollipopLabelStyleOptions implements HCOption {
  const HCPlotLollipopLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotLollipopLowMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotLollipopLowMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation when hovering over the marker.
class HCPlotLollipopMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotLollipopMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotLollipopOnPointConnectorOptions implements HCOption {
  const HCPlotLollipopOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotLollipopOnPointOptions implements HCOption {
  const HCPlotLollipopOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotLollipopOnPointPositionOptions implements HCOption {
  const HCPlotLollipopOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotLollipopOptions implements HCOption {
  ...
  /// (Highcharts, Highstock) Whether to group non-stacked lollipop points or to let them render independent of each other. Non-grouped lollipop points will be laid out individually and overlap each other.
  final bool? grouping;
  ...
  /// (Highcharts, Highstock) Options for the lower markers of the dumbbell-like series. When `lowMarker` is not defined, options inherit form the marker.
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLollipopStatesHoverAnimationOptions implements HCOption {
  const HCPlotLollipopStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotLollipopStatesInactiveAnimationOptions implements HCOption {
  const HCPlotLollipopStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLollipopStatesSelectAnimationOptions implements HCOption {
  const HCPlotLollipopStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotLollipopTooltipDateTimeLabelFormatsOptions implements HCOption {
...
class HCPlotLollipopTooltipHeaderOptions implements HCOption {
  const HCPlotLollipopTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotLollipopTooltipPositionOptions implements HCOption {
  const HCPlotLollipopTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotMacdAccessibilityPointOptions implements HCOption {
  const HCPlotMacdAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotMacdDataLabelsOptions implements HCOption {
  const HCPlotMacdDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotMacdDataSortingOptions implements HCOption {
  const HCPlotMacdDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotMacdLabelStyleOptions implements HCOption {
  const HCPlotMacdLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotMacdMacdLineStylesOptions implements HCOption {
  const HCPlotMacdMacdLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotMacdMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotMacdMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotMacdOnPointConnectorOptions implements HCOption {
  const HCPlotMacdOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotMacdOnPointOptions implements HCOption {
  const HCPlotMacdOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
class HCPlotMacdOptions implements HCOption {
  const HCPlotMacdOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotMacdDataSortingOptions? dataSorting;
  ...
  /// (Highstock) The styles for macd line
  final HCPlotMacdMacdLineOptions? macdLine;
  ...
  /// (Highstock) Parameters used in calculation of regression series' points.
  final HCPlotMacdParamsOptions? params;
  ...
  final HCPlotMacdSignalLineOptions? signalLine;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (signalLine != null) {
      json['signalLine'] = signalLine!.toJson();
    }
    if (skipKeyboardNavigation != null) {
      json['skipKeyboardNavigation'] = skipKeyboardNavigation;
    }
...
class HCPlotMacdSignalLineStylesOptions implements HCOption {
  const HCPlotMacdSignalLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotMacdStatesHoverAnimationOptions implements HCOption {
  const HCPlotMacdStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotMacdStatesInactiveAnimationOptions implements HCOption {
  const HCPlotMacdStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotMacdStatesSelectAnimationOptions implements HCOption {
  const HCPlotMacdStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotMacdTooltipDateTimeLabelFormatsOptions implements HCOption {
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotMacdTooltipHeaderOptions implements HCOption {
  const HCPlotMacdTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotMacdTooltipPositionOptions implements HCOption {
  const HCPlotMacdTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotMapAccessibilityPointOptions implements HCOption {
  const HCPlotMapAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
  ...
  /// (Highmaps) Date format to use for points on datetime axes when describing them to screen reader users.
  final String? dateFormat;

  /// (Highmaps) Whether or not to describe points with the value `null` to assistive technology, such as screen readers.
  final bool? describeNull;

  /// (Highmaps) A format string to use instead of the default for point descriptions.
  final String? descriptionFormat;

  /// (Highmaps) Decimals to use for the values in the point descriptions. Uses tooltip.valueDecimals if not defined.
  final num? valueDecimals;

  /// (Highmaps) Format to use for describing the values of data points to assistive technology - including screen readers. The point context is available as `{point}`.
  final String? valueDescriptionFormat;

  /// (Highmaps) Prefix to add to the values in the point descriptions. Uses tooltip.valuePrefix if not defined.
  final String? valuePrefix;

  /// (Highmaps) Suffix to add to the values in the point descriptions. Uses tooltip.valueSuffix if not defined.
  final String? valueSuffix;
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotMapDataLabelsAnimationOptions implements HCOption {
  const HCPlotMapDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotMapDataLabelsOptions implements HCOption {
  const HCPlotMapDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotMapOnPointConnectorOptions implements HCOption {
  const HCPlotMapOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotMapOnPointOptions implements HCOption {
  const HCPlotMapOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highmaps) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotMapOnPointPositionOptions implements HCOption {
  const HCPlotMapOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotMapOptions implements HCOption {
  ...
  final bool? affectsMapView;

  /// (Highmaps) Whether all areas of the map defined in `mapData` should be rendered. If `true`, areas which don't correspond to a data point, are rendered as `null` points. If `false`, those areas are skipped.
  final bool? allAreas;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (affectsMapView != null) {
      json['affectsMapView'] = affectsMapView;
    }
    if (allAreas != null) {
      json['allAreas'] = allAreas;
    }
    if (allowPointSelect != null) {
      json['allowPointSelect'] = allowPointSelect;
    }
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotMapTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotMapTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotMapTooltipHeaderOptions implements HCOption {
  const HCPlotMapTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotMapTooltipPositionOptions implements HCOption {
  const HCPlotMapTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highmaps) Point accessibility options for a series.
class HCPlotMapbubbleAccessibilityPointOptions implements HCOption {
  const HCPlotMapbubbleAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotMapbubbleDataLabelsAnimationOptions implements HCOption {
  const HCPlotMapbubbleDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotMapbubbleDataLabelsOptions implements HCOption {
  const HCPlotMapbubbleDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highmaps) Options for the connector in the _Series on point_ feature.
class HCPlotMapbubbleOnPointConnectorOptions implements HCOption {
  const HCPlotMapbubbleOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highmaps) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotMapbubbleOnPointOptions implements HCOption {
  const HCPlotMapbubbleOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highmaps) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotMapbubbleOnPointPositionOptions implements HCOption {
  const HCPlotMapbubbleOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotMapbubbleOptions implements HCOption {
  ...
  /// (Highmaps) If there are more points in the series than the `animationLimit`, the animation won't run. Animation affects overall performance and doesn't work well with heavy data series.
  final num? animationLimit;
  ...
  /// (Highmaps) The main color of the series. This color affects both the fill and the stroke of the bubble. For enhanced control, use `marker` options.
  final dynamic color;
  ...
  /// (Highmaps) Whether to display negative sized bubbles. The threshold is given by the zThreshold option, and negative bubbles can be visualized by setting negativeColor.
  ...
  /// (Highmaps) Color of the line connecting bubbles. The default value is the same as series' color.
  final dynamic lineColor;
  ...
  /// (Highmaps) Maximum bubble size. Bubbles will automatically size between the `minSize` and `maxSize` to reflect the `z` value of each bubble. Can be either pixels (when no unit is given), or a percentage of the smallest one of the plot width and height.
  final dynamic maxSize;

  /// (Highmaps) Minimum bubble size. Bubbles will automatically size between the `minSize` and `maxSize` to reflect the `z` value of each bubble. Can be either pixels (when no unit is given), or a percentage of the smallest one of the plot width and height.
  ...
  /// (Highmaps) Whether the bubble's value should be represented by the area or the width of the bubble. The default, `area`, corresponds best to the human perception of the size of each bubble.
  final String? sizeBy;
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotMapbubbleTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotMapbubbleTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock, Highmaps) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotMapbubbleTooltipHeaderOptions implements HCOption {
  const HCPlotMapbubbleTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts, Highstock, Highmaps) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotMapbubbleTooltipPositionOptions implements HCOption {
  const HCPlotMapbubbleTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotMaplineDataLabelsAnimationOptions implements HCOption {
  const HCPlotMaplineDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotMaplineDataLabelsOptions implements HCOption {
  const HCPlotMaplineDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highmaps) Options for the connector in the _Series on point_ feature.
class HCPlotMaplineOnPointConnectorOptions implements HCOption {
  const HCPlotMaplineOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highmaps) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotMaplineOnPointPositionOptions implements HCOption {
  const HCPlotMaplineOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotMaplineOptions implements HCOption {
  const HCPlotMaplineOptions({
    this.accessibility,
    this.affectsMapView,
    this.allAreas,
    this.allowPointSelect,
...
/// (Highmaps) Animation when not hovering over the marker.
class HCPlotMaplineStatesInactiveAnimationOptions implements HCOption {
  const HCPlotMaplineStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotMaplineTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotMaplineTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock, Highmaps) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotMaplineTooltipHeaderOptions implements HCOption {
  const HCPlotMaplineTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts, Highstock, Highmaps) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotMaplineTooltipPositionOptions implements HCOption {
  const HCPlotMaplineTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highmaps) Point accessibility options for a series.
class HCPlotMappointAccessibilityPointOptions implements HCOption {
  const HCPlotMappointAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotMappointClusterDataLabelsAnimationOptions implements HCOption {
  const HCPlotMappointClusterDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotMappointClusterDataLabelsOptions implements HCOption {
  const HCPlotMappointClusterDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
