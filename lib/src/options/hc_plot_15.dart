...
class HCPlotSankeyAccessibilityPointOptions implements HCOption {
  const HCPlotSankeyAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
class HCPlotSankeyDataLabelsAnimationOptions implements HCOption {
  const HCPlotSankeyDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotSankeyLabelStyleOptions implements HCOption {
  const HCPlotSankeyLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotSankeyLevelsDataLabelsAnimationOptions implements HCOption {
  const HCPlotSankeyLevelsDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotSankeyLevelsOptions implements HCOption {
  const HCPlotSankeyLevelsOptions({
    this.borderColor,
    this.borderWidth,
    this.color,
    this.colorByPoint,
...
class HCPlotSankeyLevelsStatesHoverAnimationOptions implements HCOption {
  const HCPlotSankeyLevelsStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotSankeyLevelsStatesInactiveAnimationOptions implements HCOption {
  const HCPlotSankeyLevelsStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSankeyLevelsStatesSelectAnimationOptions implements HCOption {
  const HCPlotSankeyLevelsStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotSankeyOnPointConnectorOptions implements HCOption {
  const HCPlotSankeyOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotSankeyOnPointOptions implements HCOption {
  const HCPlotSankeyOnPointOptions({
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotSankeyOnPointPositionOptions implements HCOption {
  const HCPlotSankeyOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotSankeyOptions implements HCOption {
  const HCPlotSankeyOptions({
    this.accessibility,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSankeyStatesHoverAnimationOptions implements HCOption {
  const HCPlotSankeyStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Animation when not hovering over the marker.
class HCPlotSankeyStatesInactiveAnimationOptions implements HCOption {
  const HCPlotSankeyStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSankeyStatesSelectAnimationOptions implements HCOption {
  const HCPlotSankeyStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotSankeyTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotSankeyTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotSankeyTooltipHeaderOptions implements HCOption {
  const HCPlotSankeyTooltipHeaderOptions({
...
class HCPlotSankeyTooltipPositionOptions implements HCOption {
  const HCPlotSankeyTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts) Point accessibility options for a series.
class HCPlotScatter3dAccessibilityPointOptions implements HCOption {
  const HCPlotScatter3dAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
class HCPlotScatter3dDataLabelsOptions implements HCOption {
  const HCPlotScatter3dDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotScatter3dDataSortingOptions implements HCOption {
  const HCPlotScatter3dDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotScatter3dJitterOptions implements HCOption {
  const HCPlotScatter3dJitterOptions({
    this.x,
    this.y,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotScatter3dLabelStyleOptions implements HCOption {
  const HCPlotScatter3dLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts) Options for the connector in the _Series on point_ feature.
class HCPlotScatter3dOnPointConnectorOptions implements HCOption {
  const HCPlotScatter3dOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highcharts) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotScatter3dOnPointOptions implements HCOption {
  const HCPlotScatter3dOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotScatter3dOnPointPositionOptions implements HCOption {
  const HCPlotScatter3dOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotScatter3dStatesHoverAnimationOptions implements HCOption {
  const HCPlotScatter3dStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Animation when not hovering over the marker.
class HCPlotScatter3dStatesInactiveAnimationOptions implements HCOption {
  const HCPlotScatter3dStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotScatter3dStatesSelectAnimationOptions implements HCOption {
  const HCPlotScatter3dStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotScatter3dTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotScatter3dTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotScatter3dTooltipHeaderOptions implements HCOption {
  const HCPlotScatter3dTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotScatter3dTooltipPositionOptions implements HCOption {
  const HCPlotScatter3dTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotScatterAccessibilityPointOptions implements HCOption {
  const HCPlotScatterAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotScatterClusterDataLabelsAnimationOptions implements HCOption {
  const HCPlotScatterClusterDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotScatterClusterDataLabelsOptions implements HCOption {
  const HCPlotScatterClusterDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotScatterClusterEventsOptions implements HCOption {
  const HCPlotScatterClusterEventsOptions();
...
class HCPlotScatterClusterLayoutAlgorithmOptions implements HCOption {
  const HCPlotScatterClusterLayoutAlgorithmOptions({
    this.distance,
    this.gridSize,
    this.iterations,
...
class HCPlotScatterClusterOptions implements HCOption {
  const HCPlotScatterClusterOptions({
    this.allowOverlap,
    this.animation,
    this.dataLabels,
    this.drillToCluster,
  ...
  final HCPlotScatterClusterEventsOptions? events;

  /// (Highcharts, Highmaps) Options for layout algorithm. Inside there are options to change the type of the algorithm, gridSize, distance or iterations.
  final HCPlotScatterClusterLayoutAlgorithmOptions? layoutAlgorithm;
  ...
  final HCPlotScatterClusterStatesOptions? states;

  /// (Highcharts, Highmaps) An array defining zones within marker clusters.
  final List<HCPlotScatterClusterZonesOptions>? zones;
...
/// (Highcharts, Highmaps) An array defining zones within marker clusters.
class HCPlotScatterClusterZonesOptions implements HCOption {
  const HCPlotScatterClusterZonesOptions({
    this.className,
    this.from,
    this.marker,
    this.to,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotScatterDataLabelsAnimationOptions implements HCOption {
  const HCPlotScatterDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotScatterDataLabelsOptions implements HCOption {
  const HCPlotScatterDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotScatterDataSortingOptions implements HCOption {
  const HCPlotScatterDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock) Apply a jitter effect for the rendered markers. When plotting discrete values, a little random noise may help telling the points apart. The jitter setting applies a random displacement of up to `n` axis units in either direction. So for example on a horizontal X axis, setting
class HCPlotScatterJitterOptions implements HCOption {
  const HCPlotScatterJitterOptions({
    this.x,
    this.y,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotScatterLabelStyleOptions implements HCOption {
  const HCPlotScatterLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotScatterMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotScatterMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotScatterOnPointConnectorOptions implements HCOption {
  const HCPlotScatterOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotScatterOnPointOptions implements HCOption {
  const HCPlotScatterOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotScatterOnPointPositionOptions implements HCOption {
  const HCPlotScatterOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotScatterOptions implements HCOption {
  const HCPlotScatterOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotScatterStatesHoverAnimationOptions implements HCOption {
  const HCPlotScatterStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotScatterStatesSelectAnimationOptions implements HCOption {
  const HCPlotScatterStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotScatterTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotScatterTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock, Highmaps) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotScatterTooltipHeaderOptions implements HCOption {
  const HCPlotScatterTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts, Highstock, Highmaps) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotScatterTooltipPositionOptions implements HCOption {
  const HCPlotScatterTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Point accessibility options for a series.
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotSeriesDataLabelsAnimationOptions implements HCOption {
  const HCPlotSeriesDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotSeriesDataLabelsOptions implements HCOption {
  const HCPlotSeriesDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotSeriesDataSortingOptions implements HCOption {
  const HCPlotSeriesDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotSeriesLabelStyleOptions implements HCOption {
  const HCPlotSeriesLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Animation when hovering over the marker.
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the connector in the _Series on point_ feature.
class HCPlotSeriesOnPointConnectorOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) A name for the dash style to use for the connector.
  final String? dashstyle;

  /// (Highcharts, Highstock, Highmaps, Gantt) Color of the connector line. By default it's the series' color.
  final String? stroke;

  /// (Highcharts, Highstock, Highmaps, Gantt) Pixel width of the connector line.
  final num? width;
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotSeriesOnPointOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) The `id` of the point that we connect the series to. Only points with a given `plotX` and `plotY` values and map points are valid.
  final String? id;

  /// (Highcharts, Highstock, Highmaps, Gantt) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
  final dynamic position;
...
class HCPlotSeriesOnPointPositionOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Series center offset from the original x position. If defined, the connector line is drawn connecting original position with new position.
  final num? offsetX;

  /// (Highcharts, Highstock, Highmaps, Gantt) Series center offset from the original y position. If defined, the connector line is drawn from original position to a new position.
  final num? offsetY;

  /// (Highcharts, Highstock, Highmaps, Gantt) X position of the series center. By default, the series is displayed on the point that it is connected to.
  final num? x;

  /// (Highcharts, Highstock, Highmaps, Gantt) Y position of the series center. By default, the series is displayed on the point that it is connected to.
  final num? y;
...
class HCPlotSeriesOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Allow this series' points to be selected by clicking on the graphic (columns, point markers, pie slices, map areas etc).
  final bool? allowPointSelect;

  /// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation of the series itself. For other animations, see chart.animation and
  final dynamic animation;

  /// (Highcharts, Highstock, Highmaps, Gantt) For some series, there is a limit that shuts down animation by default when the total number of points in the chart is too high. For example, for a column chart and its derivatives, animation does not run if there is more than 250 points totally. To disable t
  final num? animationLimit;

  /// (Highcharts, Highstock, Highmaps, Gantt) Sets the color blending in the boost module.
  final String? boostBlending;

  /// (Highcharts, Highstock, Highmaps, Gantt) Set the point threshold for when a series should enter boost mode.
  final num? boostThreshold;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) An additional class name to apply to the series' graphical elements. This option does not replace default class names of the graphical element. Changes to the series' color will also be reflected in a chart's legend and tooltip.
  final String? className;

  /// (Highcharts, Highstock, Highmaps, Gantt) Disable this option to allow series rendering in the whole plotting area.
  final bool? clip;

  /// (Highcharts, Highstock, Highmaps, Gantt) The main color of the series. In line type series it applies to the line and the point markers unless otherwise specified. In bar type series it applies to the bars unless a color is specified per point. The default value is pulled from the `options.colors` a
  final dynamic color;

  /// (Highcharts, Highstock, Highmaps) When using dual or multiple color axes, this number defines which colorAxis the particular series is connected to. It refers to either the axis id or the index of the axis in the colorAxis array, with 0 being the first. Set this option to false to prevent a series f
  final dynamic colorAxis;

  /// (Highcharts, Highstock, Highmaps, Gantt) Styled mode only. A specific color index to use for the series, so its graphic representations are given the class name `highcharts-color-{n}`.
  final num? colorIndex;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) You can set the cursor to "pointer" if you have click events attached to the series, to signal to the user that the points and lines can be clicked.
  final String? cursor;

  /// (Highcharts, Highstock, Highmaps, Gantt) A reserved subspace to store options and values for customized functionality. Here you can add additional data for your own event callbacks and formatter callbacks.
  final HCDictionary? custom;

  /// (Highcharts, Highstock, Highmaps, Gantt) Name of the dash style to use for the graph, or for some series types the outline of each shape.
  final String? dashStyle;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) The mapping between the data table and the series data points. This is used in conjunction with the `dataTable` option (on chart or series level) to map columns from the data table to the properties of the data points. The keys of the `dataMapping` object cor
  final HCDataMappingOptionsObject? dataMapping;

  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotSeriesDataSortingOptions? dataSorting;

  /// (Highcharts, Highstock, Highmaps, Gantt) Deprecated. Use plotOptions.series.accessibility.description instead.
  final String? description;

  /// (Highcharts, Highstock, Highmaps, Gantt) The draggable-points module allows points to be moved around or modified in the chart. In addition to the options mentioned under the `dragDrop` API structure, the module fires three events, point.dragStart, point.drag and point.drop.
  final HCSeriesDragDropOptionsObject? dragDrop;

  /// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the mouse tracking for a specific series. This includes point tooltips and click events on graphs and points. For large datasets it improves performance.
  final bool? enableMouseTracking;

  /// (Highcharts, Highstock, Highmaps, Gantt) General event handlers for the series items. These event hooks can also be attached to the series at run time using the `Highcharts.addEvent` function.
  final HCSeriesEventsOptionsObject? events;

  /// (Highcharts, Highstock, Highmaps, Gantt) Determines whether the series should look for the nearest point in both dimensions or just the x-dimension when hovering the series. Defaults to `'xy'` for scatter series and `'x'` for most other series. If the data has duplicate x-values, it is recommended t
  final String? findNearestPointBy;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Highlight only the hovered point and fade the remaining points.
  final bool? inactiveOtherPoints;

  /// (Highcharts, Highstock, Highmaps, Gantt) When set to `false` will prevent the series data from being included in any form of data export.
  final bool? includeInDataExport;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) An array specifying which option maps to which key in the data point array. This makes it convenient to work with unstructured data arrays from different sources.
  final List<String>? keys;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) What type of legend symbol to render for this series. Can be one of `areaMarker`, `lineMarker` or `rectangle`.
  final String? legendSymbol;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) The line cap used for line ends and line joins on the graph.
  final String? linecap;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Options for the point markers of line and scatter-like series. Properties like `fillColor`, `lineColor` and `lineWidth` define the visual appearance of the markers. The `symbol` option defines the shape. Other series types, like column series, don't have mark
  final HCPointMarkerOptionsObject? marker;

  /// (Highstock) Options for the corresponding navigator series if `showInNavigator` is `true` for this series. Available options are the same as any series, documented at plotOptions and series.
  final HCPlotSeriesOptions? navigatorOptions;

  /// (Highcharts, Highstock, Highmaps, Gantt) The color for the parts of the graph or points that are below the threshold. Note that `zones` takes precedence over the negative color. Using `negativeColor` is equivalent to applying a zone with value of 0.
  final dynamic negativeColor;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Deprecated. Use series.accessibility.point.descriptionFormat instead.
  final dynamic pointDescriptionFormat;

  /// (Highcharts, Highstock, Highmaps, Gantt) Deprecated. Use series.accessibility.point.descriptionFormatter instead.
  final dynamic pointDescriptionFormatter;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Whether to select the series initially. If `showCheckbox` is true, the checkbox next to the series name in the legend will be checked for a selected series.
  final bool? selected;

  /// (Highcharts, Highstock, Highmaps, Gantt) Whether to apply a drop shadow to the graph line. Since 2.3 the shadow can be an object configuration containing `color`, `offsetX`, `offsetY`, `opacity` and `width`.
  final dynamic shadow;

  /// (Highcharts, Highstock, Highmaps, Gantt) If true, a checkbox is displayed next to the legend item to allow selecting the series. The state of the checkbox is determined by the `selected` option.
  final bool? showCheckbox;

  /// (Highcharts, Highstock, Highmaps, Gantt) Whether to display this particular series or series type in the legend. Standalone series are shown in legend by default, and linked series are not. Since v7.2.0 it is possible to show series that use colorAxis by setting this option to `true`.
  final bool? showInLegend;

  /// (Highstock) Whether or not to show the series in the navigator. Takes precedence over navigator.baseSeries if defined.
  final bool? showInNavigator;

  /// (Highcharts, Highstock, Highmaps, Gantt) Deprecated. Use series.accessibility.keyboardNavigation instead.
  final bool? skipKeyboardNavigation;

  /// (Highcharts, Highstock) When this is true, the series will not cause the Y axis to cross the zero plane (or threshold option) unless the data actually crosses the plane.
  final bool? softThreshold;

  /// (Highcharts, Highstock, Highmaps, Gantt) Sonification/audio chart options for a series.
  final HCSeriesSonificationOptions? sonification;

  /// (Highcharts, Highstock) Whether to stack the values of each series on top of each other. Possible values are null to disable, `"normal"` to stack by value or `"percent"`.
  final String? stacking;

  /// (Highcharts, Highstock, Highmaps, Gantt) A collection of options for different series states.
  final HCSeriesStatesOptionsObject? states;

  /// (Highcharts, Highstock) Whether to apply steps to the line. Possible values are `left`, `center` and `right`.
  final String? step;

  /// (Highcharts, Highstock, Highmaps, Gantt) Sticky tracking of mouse events. When true, the `mouseOut` event on a series isn't triggered until the mouse moves over another series, or out of the plot area. When false, the `mouseOut` event on a series is triggered when the mouse leaves the area around th
  final bool? stickyTracking;

  /// (Highcharts, Highstock) The threshold, also called zero level or base level. For line type series this is only used in conjunction with negativeColor.
  final num? threshold;

  /// (Highcharts, Highstock, Highmaps, Gantt) A configuration object for the tooltip rendering of each single series. Properties are inherited from tooltip, but only the following properties can be defined on a series level.
  final HCSeriesTooltipOptionsObject? tooltip;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Set the initial visibility of the series.
  final bool? visible;
  ...
  /// (Highcharts, Highstock, Highmaps, Gantt) Whether to zoom non-cartesian series. If `chart.zooming` is set, the option allows to disable zooming on an individual non-cartesian series. By default zooming is enabled for all series.
  final bool? zoomEnabled;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSeriesStatesHoverAnimationOptions implements HCOption {
  const HCPlotSeriesStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Animation when not hovering over the marker.
class HCPlotSeriesStatesInactiveAnimationOptions implements HCOption {
  const HCPlotSeriesStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSeriesStatesSelectAnimationOptions implements HCOption {
  const HCPlotSeriesStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotSeriesTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotSeriesTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotSlowstochasticAccessibilityPointOptions implements HCOption {
  const HCPlotSlowstochasticAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotSlowstochasticDataLabelsAnimationOptions implements HCOption {
  const HCPlotSlowstochasticDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotSlowstochasticDataLabelsOptions implements HCOption {
  const HCPlotSlowstochasticDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotSlowstochasticDataSortingOptions implements HCOption {
  const HCPlotSlowstochasticDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotSlowstochasticLabelStyleOptions implements HCOption {
  const HCPlotSlowstochasticLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotSlowstochasticMarkerStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotSlowstochasticMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotSlowstochasticOnPointConnectorOptions implements HCOption {
  const HCPlotSlowstochasticOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotSlowstochasticOnPointOptions implements HCOption {
  const HCPlotSlowstochasticOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotSlowstochasticOnPointPositionOptions implements HCOption {
  const HCPlotSlowstochasticOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotSlowstochasticOptions implements HCOption {
  const HCPlotSlowstochasticOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
/// (Highstock) Styles for a smoothed line.
class HCPlotSlowstochasticSmoothedLineStylesOptions implements HCOption {
  const HCPlotSlowstochasticSmoothedLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSlowstochasticStatesHoverAnimationOptions implements HCOption {
  const HCPlotSlowstochasticStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotSlowstochasticStatesInactiveAnimationOptions implements HCOption {
  const HCPlotSlowstochasticStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotSlowstochasticStatesSelectAnimationOptions implements HCOption {
  const HCPlotSlowstochasticStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotSlowstochasticTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotSlowstochasticTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotSlowstochasticTooltipHeaderOptions implements HCOption {
  const HCPlotSlowstochasticTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotSlowstochasticTooltipPositionOptions implements HCOption {
  const HCPlotSlowstochasticTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotSmaAccessibilityPointOptions implements HCOption {
  const HCPlotSmaAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotSmaDataLabelsAnimationOptions implements HCOption {
  const HCPlotSmaDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotSmaDataLabelsOptions implements HCOption {
  const HCPlotSmaDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
