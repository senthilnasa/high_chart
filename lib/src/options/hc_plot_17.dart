...
class HCPlotSupertrendChangeTrendLineStylesOptions implements HCOption {
  ...
  /// (Highstock) The dash or dot style of the grid lines. For possible values, see this demonstration.
...
class HCPlotSupertrendParamsOptions implements HCOption {
  ...
  /// (Highstock) The base period for indicator Supertrend Indicator calculations. This is the number of data points which are taken into account for the indicator calculations.
  final num? period;
...
class HCPlotTimelineOptions implements HCOption {
  const HCPlotTimelineOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.className,
...
class HCPlotTreegraphLinkOptions implements HCOption {
  ...
  /// (Highcharts) For the orthogonal link type, this defines how far down the link bends. A number defines the pixel offset from the start of the link, and a percentage defines the relative position on the link. For example, a `bendAt` of `50%` means that the link bends in the middle.
  ...
  /// (Highcharts) Modifier of the shape of the curved link. Works best for values between 0 and 1, where 0 is a straight line, and 1 is a shape close to the default one.
...
class HCPlotTreegraphOptions implements HCOption {
  const HCPlotTreegraphOptions({
    this.accessibility,
