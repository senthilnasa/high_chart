...
class HCPlotVbpOnPointPositionOptions implements HCOption {
  const HCPlotVbpOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotVbpOptions implements HCOption {
  const HCPlotVbpOptions({
    this.accessibility,
...
class HCPlotVbpStatesHoverAnimationOptions implements HCOption {
  const HCPlotVbpStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotVbpStatesInactiveAnimationOptions implements HCOption {
  const HCPlotVbpStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVbpStatesSelectAnimationOptions implements HCOption {
  const HCPlotVbpStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotVbpTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotVbpTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotVbpTooltipHeaderOptions implements HCOption {
  const HCPlotVbpTooltipHeaderOptions({
...
class HCPlotVbpTooltipPositionOptions implements HCOption {
  const HCPlotVbpTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotVectorAccessibilityPointOptions implements HCOption {
  const HCPlotVectorAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
class HCPlotVectorClusterDataLabelsAnimationOptions implements HCOption {
  const HCPlotVectorClusterDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotVectorClusterDataLabelsOptions implements HCOption {
  const HCPlotVectorClusterDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotVectorClusterEventsOptions implements HCOption {
  const HCPlotVectorClusterEventsOptions();
...
class HCPlotVectorClusterLayoutAlgorithmOptions implements HCOption {
  const HCPlotVectorClusterLayoutAlgorithmOptions({
    this.distance,
    this.gridSize,
    this.iterations,
...
class HCPlotVectorClusterOptions implements HCOption {
  const HCPlotVectorClusterOptions({
    this.allowOverlap,
    this.animation,
    this.dataLabels,
    this.drillToCluster,
  ...
  final HCPlotVectorClusterEventsOptions? events;

  /// (Highcharts, Highmaps) Options for layout algorithm. Inside there are options to change the type of the algorithm, gridSize, distance or iterations.
  final HCPlotVectorClusterLayoutAlgorithmOptions? layoutAlgorithm;
  ...
  final HCPlotVectorClusterStatesOptions? states;

  /// (Highcharts, Highmaps) An array defining zones within marker clusters.
  final List<HCPlotVectorClusterZonesOptions>? zones;
...
/// (Highcharts, Highmaps) An array defining zones within marker clusters.
class HCPlotVectorClusterZonesOptions implements HCOption {
  const HCPlotVectorClusterZonesOptions({
    this.className,
    this.from,
    this.marker,
    this.to,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotVectorDataLabelsAnimationOptions implements HCOption {
  const HCPlotVectorDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotVectorDataLabelsOptions implements HCOption {
  const HCPlotVectorDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotVectorDataSortingOptions implements HCOption {
  const HCPlotVectorDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotVectorLabelStyleOptions implements HCOption {
  const HCPlotVectorLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotVectorOnPointOptions implements HCOption {
  const HCPlotVectorOnPointOptions({
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotVectorOnPointPositionOptions implements HCOption {
  const HCPlotVectorOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVectorStatesHoverAnimationOptions implements HCOption {
  const HCPlotVectorStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVectorStatesSelectAnimationOptions implements HCOption {
  const HCPlotVectorStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotVectorTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotVectorTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotVectorTooltipHeaderOptions implements HCOption {
  const HCPlotVectorTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotVectorTooltipPositionOptions implements HCOption {
  const HCPlotVectorTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotVennAccessibilityPointOptions implements HCOption {
  const HCPlotVennAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotVennClusterDataLabelsAnimationOptions implements HCOption {
  const HCPlotVennClusterDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the cluster data labels.
class HCPlotVennClusterDataLabelsOptions implements HCOption {
  const HCPlotVennClusterDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Styles for the label. The default `color` setting is `"contrast"`, which is a pseudo color that Highcharts picks up and applies the maximum contrast to the underlying point item, for example the bar in a bar chart.
class HCPlotVennClusterDataLabelsStyleOptions implements HCOption {
  const HCPlotVennClusterDataLabelsStyleOptions({
    this.color,
  });
...
class HCPlotVennClusterEventsOptions implements HCOption {
  const HCPlotVennClusterEventsOptions();
...
/// (Highcharts, Highmaps) Options for marker clusters, the concept of sampling the data values into larger blocks in order to ease readability and increase performance of the JavaScript charts.
class HCPlotVennClusterOptions implements HCOption {
  const HCPlotVennClusterOptions({
    this.allowOverlap,
    this.animation,
    this.dataLabels,
    this.drillToCluster,
  ...
  final HCPlotVennClusterEventsOptions? events;

  /// (Highcharts, Highmaps) Options for layout algorithm. Inside there are options to change the type of the algorithm, gridSize, distance or iterations.
  final HCPlotVennClusterLayoutAlgorithmOptions? layoutAlgorithm;
  ...
  final HCPlotVennClusterStatesOptions? states;

  /// (Highcharts, Highmaps) An array defining zones within marker clusters.
  final List<HCPlotVennClusterZonesOptions>? zones;
...
/// (Highcharts, Highmaps) An array defining zones within marker clusters.
class HCPlotVennClusterZonesOptions implements HCOption {
  const HCPlotVennClusterZonesOptions({
    this.className,
    this.from,
    this.marker,
    this.to,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotVennDataLabelsAnimationOptions implements HCOption {
  const HCPlotVennDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotVennDataLabelsOptions implements HCOption {
  const HCPlotVennDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotVennOnPointConnectorOptions implements HCOption {
  const HCPlotVennOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotVennOnPointOptions implements HCOption {
  const HCPlotVennOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotVennOnPointPositionOptions implements HCOption {
  const HCPlotVennOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVennStatesHoverAnimationOptions implements HCOption {
  const HCPlotVennStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVennStatesSelectAnimationOptions implements HCOption {
  const HCPlotVennStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotVennTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotVennTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock, Highmaps) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotVennTooltipHeaderOptions implements HCOption {
  const HCPlotVennTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts, Highstock, Highmaps) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotVennTooltipPositionOptions implements HCOption {
  const HCPlotVennTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotVwapAccessibilityPointOptions implements HCOption {
  const HCPlotVwapAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotVwapDataLabelsAnimationOptions implements HCOption {
  const HCPlotVwapDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotVwapDataLabelsOptions implements HCOption {
  const HCPlotVwapDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotVwapDataSortingOptions implements HCOption {
  const HCPlotVwapDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotVwapLabelStyleOptions implements HCOption {
  const HCPlotVwapLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotVwapMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotVwapMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotVwapOnPointConnectorOptions implements HCOption {
  const HCPlotVwapOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotVwapOnPointOptions implements HCOption {
  const HCPlotVwapOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotVwapOnPointPositionOptions implements HCOption {
  const HCPlotVwapOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotVwapOptions implements HCOption {
  const HCPlotVwapOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVwapStatesHoverAnimationOptions implements HCOption {
  const HCPlotVwapStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotVwapStatesInactiveAnimationOptions implements HCOption {
  const HCPlotVwapStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotVwapStatesSelectAnimationOptions implements HCOption {
  const HCPlotVwapStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotVwapTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotVwapTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotVwapTooltipHeaderOptions implements HCOption {
  const HCPlotVwapTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotVwapTooltipPositionOptions implements HCOption {
  const HCPlotVwapTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts) Point accessibility options for a series.
class HCPlotWaterfallAccessibilityPointOptions implements HCOption {
  const HCPlotWaterfallAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotWaterfallDataLabelsAnimationOptions implements HCOption {
  const HCPlotWaterfallDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotWaterfallDataLabelsOptions implements HCOption {
  const HCPlotWaterfallDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotWaterfallDataSortingOptions implements HCOption {
  const HCPlotWaterfallDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotWaterfallLabelStyleOptions implements HCOption {
  const HCPlotWaterfallLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts) Options for the connector in the _Series on point_ feature.
class HCPlotWaterfallOnPointConnectorOptions implements HCOption {
...
/// (Highcharts) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotWaterfallOnPointOptions implements HCOption {
  const HCPlotWaterfallOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotWaterfallOnPointPositionOptions implements HCOption {
  const HCPlotWaterfallOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWaterfallStatesHoverAnimationOptions implements HCOption {
  const HCPlotWaterfallStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Animation when not hovering over the marker.
class HCPlotWaterfallStatesInactiveAnimationOptions implements HCOption {
  const HCPlotWaterfallStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWaterfallStatesSelectAnimationOptions implements HCOption {
  const HCPlotWaterfallStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotWaterfallTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotWaterfallTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotWaterfallTooltipHeaderOptions implements HCOption {
  const HCPlotWaterfallTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotWaterfallTooltipPositionOptions implements HCOption {
  const HCPlotWaterfallTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotWilliamsrAccessibilityPointOptions implements HCOption {
  const HCPlotWilliamsrAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotWilliamsrDataLabelsAnimationOptions implements HCOption {
  const HCPlotWilliamsrDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotWilliamsrDataLabelsOptions implements HCOption {
  const HCPlotWilliamsrDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotWilliamsrDataSortingOptions implements HCOption {
  const HCPlotWilliamsrDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotWilliamsrLabelStyleOptions implements HCOption {
  const HCPlotWilliamsrLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotWilliamsrOnPointConnectorOptions implements HCOption {
  const HCPlotWilliamsrOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotWilliamsrOnPointOptions implements HCOption {
  const HCPlotWilliamsrOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotWilliamsrOnPointPositionOptions implements HCOption {
  const HCPlotWilliamsrOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotWilliamsrOptions implements HCOption {
  const HCPlotWilliamsrOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
