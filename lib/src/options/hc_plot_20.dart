...
class HCPlotWilliamsrStatesHoverAnimationOptions implements HCOption {
  const HCPlotWilliamsrStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotWilliamsrStatesInactiveAnimationOptions implements HCOption {
  const HCPlotWilliamsrStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWilliamsrStatesSelectAnimationOptions implements HCOption {
  const HCPlotWilliamsrStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotWilliamsrTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotWilliamsrTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotWilliamsrTooltipHeaderOptions implements HCOption {
  const HCPlotWilliamsrTooltipHeaderOptions({
...
class HCPlotWilliamsrTooltipPositionOptions implements HCOption {
  const HCPlotWilliamsrTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotWindbarbDataLabelsAnimationOptions implements HCOption {
  const HCPlotWindbarbDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotWindbarbDataLabelsOptions implements HCOption {
  const HCPlotWindbarbDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotWindbarbDataSortingOptions implements HCOption {
  const HCPlotWindbarbDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotWindbarbLabelStyleOptions implements HCOption {
  const HCPlotWindbarbLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotWindbarbOnPointConnectorOptions implements HCOption {
  const HCPlotWindbarbOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotWindbarbOnPointOptions implements HCOption {
  const HCPlotWindbarbOnPointOptions({
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotWindbarbOnPointPositionOptions implements HCOption {
  const HCPlotWindbarbOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotWindbarbOptions implements HCOption {
  const HCPlotWindbarbOptions({
    this.accessibility,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWindbarbStatesHoverAnimationOptions implements HCOption {
  const HCPlotWindbarbStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotWindbarbStatesInactiveAnimationOptions implements HCOption {
  const HCPlotWindbarbStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWindbarbStatesSelectAnimationOptions implements HCOption {
  const HCPlotWindbarbStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotWindbarbTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotWindbarbTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotWindbarbTooltipHeaderOptions implements HCOption {
  const HCPlotWindbarbTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotWindbarbTooltipPositionOptions implements HCOption {
  const HCPlotWindbarbTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotWmaDataLabelsAnimationOptions implements HCOption {
  const HCPlotWmaDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotWmaDataLabelsOptions implements HCOption {
  const HCPlotWmaDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotWmaDataSortingOptions implements HCOption {
  const HCPlotWmaDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotWmaLabelStyleOptions implements HCOption {
  const HCPlotWmaLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotWmaOnPointConnectorOptions implements HCOption {
  const HCPlotWmaOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotWmaOnPointOptions implements HCOption {
  const HCPlotWmaOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotWmaOnPointPositionOptions implements HCOption {
  const HCPlotWmaOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotWmaOptions implements HCOption {
  const HCPlotWmaOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWmaStatesHoverAnimationOptions implements HCOption {
  const HCPlotWmaStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotWmaStatesInactiveAnimationOptions implements HCOption {
  const HCPlotWmaStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWmaStatesSelectAnimationOptions implements HCOption {
  const HCPlotWmaStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotWmaTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotWmaTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotWmaTooltipHeaderOptions implements HCOption {
  const HCPlotWmaTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotWmaTooltipPositionOptions implements HCOption {
  const HCPlotWmaTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotWordcloudAccessibilityPointOptions implements HCOption {
  const HCPlotWordcloudAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotWordcloudLabelStyleOptions implements HCOption {
  const HCPlotWordcloudLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotWordcloudOnPointConnectorOptions implements HCOption {
  const HCPlotWordcloudOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotWordcloudOnPointOptions implements HCOption {
  const HCPlotWordcloudOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotWordcloudOnPointPositionOptions implements HCOption {
  const HCPlotWordcloudOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotWordcloudOptions implements HCOption {
  const HCPlotWordcloudOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
class HCPlotWordcloudRotationOptions implements HCOption {
  ...
  /// (Highcharts) The number of possible orientations for a word, within the range of `rotation.from` and `rotation.to`. Must be a number larger than 0.
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWordcloudStatesHoverAnimationOptions implements HCOption {
  const HCPlotWordcloudStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotWordcloudStatesInactiveAnimationOptions implements HCOption {
  const HCPlotWordcloudStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotWordcloudStatesSelectAnimationOptions implements HCOption {
  const HCPlotWordcloudStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotWordcloudTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotWordcloudTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotWordcloudTooltipHeaderOptions implements HCOption {
  const HCPlotWordcloudTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotWordcloudTooltipPositionOptions implements HCOption {
  const HCPlotWordcloudTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotXrangeAccessibilityPointOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Gantt) Date format to use for points on datetime axes when describing them to screen reader users.
  final String? dateFormat;

  /// (Highcharts, Highstock, Gantt) Whether or not to describe points with the value `null` to assistive technology, such as screen readers.
  final bool? describeNull;

  /// (Highcharts, Highstock, Gantt) A format string to use instead of the default for point descriptions.
  final String? descriptionFormat;

  /// (Highcharts, Highstock, Gantt) Decimals to use for the values in the point descriptions. Uses tooltip.valueDecimals if not defined.
  final num? valueDecimals;

  /// (Highcharts, Highstock, Gantt) Format to use for describing the values of data points to assistive technology - including screen readers. The point context is available as `{point}`.
  final String? valueDescriptionFormat;

  /// (Highcharts, Highstock, Gantt) Prefix to add to the values in the point descriptions. Uses tooltip.valuePrefix if not defined.
  final String? valuePrefix;

  /// (Highcharts, Highstock, Gantt) Suffix to add to the values in the point descriptions. Uses tooltip.valueSuffix if not defined.
  final String? valueSuffix;
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotXrangeDataLabelsAnimationOptions implements HCOption {
  const HCPlotXrangeDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotXrangeDataLabelsOptions implements HCOption {
  const HCPlotXrangeDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotXrangeLabelStyleOptions implements HCOption {
  const HCPlotXrangeLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts, Highstock, Gantt) Options for the connector in the _Series on point_ feature.
class HCPlotXrangeOnPointConnectorOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Gantt) A name for the dash style to use for the connector.
  final String? dashstyle;

  /// (Highcharts, Highstock, Gantt) Color of the connector line. By default it's the series' color.
  final String? stroke;
...
class HCPlotXrangeOnPointOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Gantt) The `id` of the point that we connect the series to. Only points with a given `plotX` and `plotY` values and map points are valid.
  final String? id;

  /// (Highcharts, Highstock, Gantt) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
  final dynamic position;
...
class HCPlotXrangeOnPointPositionOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Gantt) Series center offset from the original x position. If defined, the connector line is drawn connecting original position with new position.
  final num? offsetX;

  /// (Highcharts, Highstock, Gantt) Series center offset from the original y position. If defined, the connector line is drawn from original position to a new position.
  final num? offsetY;

  /// (Highcharts, Highstock, Gantt) X position of the series center. By default, the series is displayed on the point that it is connected to.
  final num? x;

  /// (Highcharts, Highstock, Gantt) Y position of the series center. By default, the series is displayed on the point that it is connected to.
  final num? y;
...
class HCPlotXrangeOptions implements HCOption {
  const HCPlotXrangeOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotXrangeStatesHoverAnimationOptions implements HCOption {
  const HCPlotXrangeStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotXrangeStatesSelectAnimationOptions implements HCOption {
  const HCPlotXrangeStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotXrangeTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotXrangeTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock, Gantt) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotXrangeTooltipHeaderOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Gantt) Background color for the tooltip header when tooltip.split is enabled.
  final dynamic backgroundColor;

  /// (Highcharts, Highstock, Gantt) Border color for the tooltip header when tooltip.split is enabled.
  final dynamic borderColor;

  /// (Highcharts, Highstock, Gantt) The width of the border for the tooltip header when tooltip.split is enabled.
  final num? borderWidth;

  /// (Highcharts, Highstock, Gantt) Distance between the plot area and the header (except the chevron) in a split tooltip, in pixels. The default value makes the header text align with the axis labels.
  final num? distance;

  /// (Highcharts, Highstock, Gantt) The name of a symbol to use for the border around the tooltip header. Applies only when tooltip.split is enabled.
  final String? shape;

  /// (Highcharts, Highstock, Gantt) CSS styles for the tooltip header. The default is `{ fontSize: '1em' }`, ensuring that the header text is the same size as the axis labels.
  final dynamic style;
...
/// (Highcharts, Highstock, Gantt) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotXrangeTooltipPositionOptions implements HCOption {
  ...
  /// (Highcharts, Highstock, Gantt) The horizontal alignment of the fixed tooltip.
  final String? align;

  /// (Highcharts, Highstock, Gantt) What the fixed tooltip alignment should be relative to.
  final String? relativeTo;

  /// (Highcharts, Highstock, Gantt) The vertical alignment of the fixed tooltip.
  final String? verticalAlign;

  /// (Highcharts, Highstock, Gantt) X pixel offset from the given position. Can be used to shy away from axis lines, grid lines etc to avoid the tooltip overlapping other elements.
  final num? x;

  /// (Highcharts, Highstock, Gantt) Y pixel offset from the given position. Can be used to shy away from axis lines, grid lines etc to avoid the tooltip overlapping other elements.
  final num? y;
...
/// (Highstock) Point accessibility options for a series.
class HCPlotZigzagAccessibilityPointOptions implements HCOption {
  const HCPlotZigzagAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotZigzagDataLabelsAnimationOptions implements HCOption {
  const HCPlotZigzagDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotZigzagDataLabelsOptions implements HCOption {
  const HCPlotZigzagDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotZigzagDataSortingOptions implements HCOption {
  const HCPlotZigzagDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotZigzagLabelStyleOptions implements HCOption {
  const HCPlotZigzagLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotZigzagMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotZigzagMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotZigzagOnPointConnectorOptions implements HCOption {
  const HCPlotZigzagOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotZigzagOnPointOptions implements HCOption {
  const HCPlotZigzagOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotZigzagOnPointPositionOptions implements HCOption {
  const HCPlotZigzagOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotZigzagOptions implements HCOption {
  const HCPlotZigzagOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
class HCPlotZigzagParamsOptions implements HCOption {
  ...
  /// (Highstock) The point index which indicator calculations will base - high value.
  final num? highIndex;

  final String? index;

  /// (Highstock) The point index which indicator calculations will base - low value.
  final num? lowIndex;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotZigzagStatesHoverAnimationOptions implements HCOption {
  const HCPlotZigzagStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotZigzagStatesInactiveAnimationOptions implements HCOption {
  const HCPlotZigzagStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotZigzagStatesSelectAnimationOptions implements HCOption {
  const HCPlotZigzagStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotZigzagTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotZigzagTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotZigzagTooltipHeaderOptions implements HCOption {
  const HCPlotZigzagTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotZigzagTooltipPositionOptions implements HCOption {
  const HCPlotZigzagTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
