...
class HCPlotAtrOptions implements HCOption {
  ...
  final HCPlotAtrDataSortingOptions? dataSorting;
  ...
  final HCPlotAtrParamsOptions? params;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotAtrParamsOptions implements HCOption {
  const HCPlotAtrParamsOptions({
    this.index,
    this.period,
  });
...
class HCPlotAtrStatesHoverAnimationOptions implements HCOption {
  const HCPlotAtrStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotAtrStatesInactiveAnimationOptions implements HCOption {
  const HCPlotAtrStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotAtrStatesSelectAnimationOptions implements HCOption {
  const HCPlotAtrStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotAtrTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotAtrTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotAtrTooltipHeaderOptions implements HCOption {
  const HCPlotAtrTooltipHeaderOptions({
...
class HCPlotAtrTooltipPositionOptions implements HCOption {
  const HCPlotAtrTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotBarAccessibilityPointOptions implements HCOption {
  const HCPlotBarAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
class HCPlotBarDataLabelsAnimationOptions implements HCOption {
  const HCPlotBarDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotBarDataLabelsOptions implements HCOption {
  const HCPlotBarDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotBarDataSortingOptions implements HCOption {
  const HCPlotBarDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotBarLabelStyleOptions implements HCOption {
  const HCPlotBarLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotBarOnPointConnectorOptions implements HCOption {
  const HCPlotBarOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotBarOnPointOptions implements HCOption {
  const HCPlotBarOnPointOptions({
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotBarOnPointPositionOptions implements HCOption {
  const HCPlotBarOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotBarOptions implements HCOption {
  const HCPlotBarOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotBarDataSortingOptions? dataSorting;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBarStatesHoverAnimationOptions implements HCOption {
  const HCPlotBarStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBarStatesSelectAnimationOptions implements HCOption {
  const HCPlotBarStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotBarTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotBarTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotBarTooltipHeaderOptions implements HCOption {
  const HCPlotBarTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotBarTooltipPositionOptions implements HCOption {
  const HCPlotBarTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotBbAccessibilityPointOptions implements HCOption {
  const HCPlotBbAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highstock) Styles for the bottom line.
class HCPlotBbBottomLineStylesOptions implements HCOption {
  const HCPlotBbBottomLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });

  /// (Highstock) Color of the line. If not set, it's inherited from plotOptions.bb.color.
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotBbDataLabelsAnimationOptions implements HCOption {
  const HCPlotBbDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotBbDataLabelsOptions implements HCOption {
  const HCPlotBbDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotBbDataSortingOptions implements HCOption {
  const HCPlotBbDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotBbLabelStyleOptions implements HCOption {
  const HCPlotBbLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotBbMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotBbMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotBbOnPointConnectorOptions implements HCOption {
  const HCPlotBbOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotBbOnPointOptions implements HCOption {
  const HCPlotBbOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotBbOnPointPositionOptions implements HCOption {
  const HCPlotBbOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotBbOptions implements HCOption {
  const HCPlotBbOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highstock) Bottom line options.
  final HCPlotBbBottomLineOptions? bottomLine;
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotBbDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Option for fill color between lines in Bollinger Bands Indicator.
  ...
  final HCPlotBbParamsOptions? params;
  ...
  final HCPlotBbTopLineOptions? topLine;
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotBbStatesInactiveAnimationOptions implements HCOption {
  const HCPlotBbStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBbStatesSelectAnimationOptions implements HCOption {
  const HCPlotBbStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotBbTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotBbTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotBbTooltipHeaderOptions implements HCOption {
  const HCPlotBbTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotBbTooltipPositionOptions implements HCOption {
  const HCPlotBbTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Styles for the top line.
class HCPlotBbTopLineStylesOptions implements HCOption {
  const HCPlotBbTopLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });
...
/// (Highcharts) Point accessibility options for a series.
class HCPlotBellcurveAccessibilityPointOptions implements HCOption {
  const HCPlotBellcurveAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotBellcurveDataLabelsOptions implements HCOption {
  const HCPlotBellcurveDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotBellcurveDataSortingOptions implements HCOption {
  const HCPlotBellcurveDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotBellcurveLabelStyleOptions implements HCOption {
  const HCPlotBellcurveLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotBellcurveMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotBellcurveMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Options for the connector in the _Series on point_ feature.
class HCPlotBellcurveOnPointConnectorOptions implements HCOption {
  const HCPlotBellcurveOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highcharts) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotBellcurveOnPointOptions implements HCOption {
  const HCPlotBellcurveOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotBellcurveOnPointPositionOptions implements HCOption {
  const HCPlotBellcurveOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotBellcurveOptions implements HCOption {
  ...
  /// (Highcharts) This option allows to define the length of the bell curve. A unit of the length of the bell curve is standard deviation.
  final num? intervals;
  ...
  /// (Highcharts) Defines how many points should be plotted within 1 interval. See `plotOptions.bellcurve.intervals`.
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBellcurveStatesHoverAnimationOptions implements HCOption {
  const HCPlotBellcurveStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBellcurveStatesSelectAnimationOptions implements HCOption {
  const HCPlotBellcurveStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotBellcurveTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotBellcurveTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotBellcurveTooltipHeaderOptions implements HCOption {
  const HCPlotBellcurveTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotBellcurveTooltipPositionOptions implements HCOption {
  const HCPlotBellcurveTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts) Point accessibility options for a series.
class HCPlotBoxplotAccessibilityPointOptions implements HCOption {
  const HCPlotBoxplotAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotBoxplotDataLabelsAnimationOptions implements HCOption {
  const HCPlotBoxplotDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotBoxplotDataLabelsOptions implements HCOption {
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotBoxplotDataSortingOptions implements HCOption {
  const HCPlotBoxplotDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotBoxplotLabelStyleOptions implements HCOption {
  const HCPlotBoxplotLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts) Options for the connector in the _Series on point_ feature.
class HCPlotBoxplotOnPointConnectorOptions implements HCOption {
  const HCPlotBoxplotOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highcharts) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotBoxplotOnPointOptions implements HCOption {
  const HCPlotBoxplotOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotBoxplotOnPointPositionOptions implements HCOption {
  const HCPlotBoxplotOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotBoxplotOptions implements HCOption {
  const HCPlotBoxplotOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotBoxplotDataSortingOptions? dataSorting;
  ...
  /// (Highcharts) The width of the line surrounding the box. If any of stemWidth, medianWidth or whiskerWidth are `null`, the lineWidth also applies to these lines.
  final num? lineWidth;
  ...
  /// (Highcharts) The color of the median line. If `undefined`, the general series color applies.
  final dynamic medianColor;

  /// (Highcharts) The dash style of the median.
  final String? medianDashStyle;

  /// (Highcharts) The pixel width of the median line. If `null`, the lineWidth is used.
  ...
  /// (Highcharts) The color of the stem, the vertical line extending from the box to the whiskers. If `undefined`, the series color is used.
  final dynamic stemColor;

  /// (Highcharts) The dash style of the stem, the vertical line extending from the box to the whiskers.
  final String? stemDashStyle;

  /// (Highcharts) The width of the stem, the vertical line extending from the box to the whiskers. If `undefined`, the width is inherited from the lineWidth option.
  final num? stemWidth;
  ...
  /// (Highcharts) The color of the whiskers, the horizontal lines marking low and high values. When `undefined`, the general series color is used.
  final dynamic whiskerColor;

  /// (Highcharts) The dash style of the whiskers.
  final String? whiskerDashStyle;

  /// (Highcharts) The length of the whiskers, the horizontal lines marking low and high values. It can be a numerical pixel value, or a percentage value of the box width. Set `0` to disable whiskers.
  final dynamic whiskerLength;

  /// (Highcharts) The line width of the whiskers, the horizontal lines marking low and high values. When `undefined`, the general lineWidth applies.
  ...
  Map<String, dynamic> toJson() {
    ...
    if (medianColor != null) {
      json['medianColor'] = hcJsonValue(medianColor);
    }
    if (medianDashStyle != null) {
      json['medianDashStyle'] = medianDashStyle;
    }
    if (medianWidth != null) {
      json['medianWidth'] = medianWidth;
    }
    if (minPointLength != null) {
      json['minPointLength'] = minPointLength;
    }
    ...
    if (stemColor != null) {
      json['stemColor'] = hcJsonValue(stemColor);
    }
    if (stemDashStyle != null) {
      json['stemDashStyle'] = stemDashStyle;
    }
    if (stemWidth != null) {
      json['stemWidth'] = stemWidth;
    }
    if (stickyTracking != null) {
      json['stickyTracking'] = stickyTracking;
    }
    ...
    if (whiskerColor != null) {
      json['whiskerColor'] = hcJsonValue(whiskerColor);
    }
    if (whiskerDashStyle != null) {
      json['whiskerDashStyle'] = whiskerDashStyle;
    }
    if (whiskerLength != null) {
      json['whiskerLength'] = hcJsonValue(whiskerLength);
    }
    if (whiskerWidth != null) {
      json['whiskerWidth'] = whiskerWidth;
    }
    if (zoneAxis != null) {
      json['zoneAxis'] = zoneAxis;
    }
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotBoxplotTooltipDateTimeLabelFormatsOptions implements HCOption {
...
/// (Highcharts) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotBoxplotTooltipHeaderOptions implements HCOption {
  const HCPlotBoxplotTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotBoxplotTooltipPositionOptions implements HCOption {
  const HCPlotBoxplotTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotBubbleAccessibilityPointOptions implements HCOption {
  const HCPlotBubbleAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotBubbleDataLabelsAnimationOptions implements HCOption {
  const HCPlotBubbleDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotBubbleDataLabelsOptions implements HCOption {
  const HCPlotBubbleDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotBubbleLabelStyleOptions implements HCOption {
  const HCPlotBubbleLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotBubbleMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotBubbleMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotBubbleOnPointConnectorOptions implements HCOption {
  const HCPlotBubbleOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotBubbleOnPointOptions implements HCOption {
  const HCPlotBubbleOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotBubbleOnPointPositionOptions implements HCOption {
  const HCPlotBubbleOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotBubbleOptions implements HCOption {
  ...
  /// (Highcharts, Highstock) If there are more points in the series than the `animationLimit`, the animation won't run. Animation affects overall performance and doesn't work well with heavy data series.
  final num? animationLimit;
  ...
  /// (Highcharts, Highstock) Maximum bubble size. Bubbles will automatically size between the `minSize` and `maxSize` to reflect the `z` value of each bubble. Can be either pixels (when no unit is given), or a percentage of the smallest one of the plot width and height.
  final dynamic maxSize;

  /// (Highcharts, Highstock) Minimum bubble size. Bubbles will automatically size between the `minSize` and `maxSize` to reflect the `z` value of each bubble. Can be either pixels (when no unit is given), or a percentage of the smallest one of the plot width and height.
  ...
  /// (Highcharts, Highstock) Whether the bubble's value should be represented by the area or the width of the bubble. The default, `area`, corresponds best to the human perception of the size of each bubble.
  final String? sizeBy;

  /// (Highcharts) When this is true, the absolute value of z determines the size of the bubble. This means that with the default `zThreshold` of 0, a bubble of value -1 will have the same size as a bubble of value 1, while a bubble of value 0 will have a smaller size according to `minSize`.
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBubbleStatesHoverAnimationOptions implements HCOption {
  const HCPlotBubbleStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotBubbleStatesInactiveAnimationOptions implements HCOption {
  const HCPlotBubbleStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBubbleStatesSelectAnimationOptions implements HCOption {
  const HCPlotBubbleStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotBubbleTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotBubbleTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotBubbleTooltipHeaderOptions implements HCOption {
  const HCPlotBubbleTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotBubbleTooltipPositionOptions implements HCOption {
  const HCPlotBubbleTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts) Point accessibility options for a series.
class HCPlotBulletAccessibilityPointOptions implements HCOption {
  const HCPlotBulletAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotBulletDataLabelsAnimationOptions implements HCOption {
  const HCPlotBulletDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotBulletDataLabelsOptions implements HCOption {
  const HCPlotBulletDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotBulletLabelStyleOptions implements HCOption {
  const HCPlotBulletLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts) Options for the connector in the _Series on point_ feature.
class HCPlotBulletOnPointConnectorOptions implements HCOption {
  const HCPlotBulletOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highcharts) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotBulletOnPointOptions implements HCOption {
  const HCPlotBulletOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotBulletOnPointPositionOptions implements HCOption {
  const HCPlotBulletOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotBulletOptions implements HCOption {
  const HCPlotBulletOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBulletStatesHoverAnimationOptions implements HCOption {
  const HCPlotBulletStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Animation when not hovering over the marker.
class HCPlotBulletStatesInactiveAnimationOptions implements HCOption {
  const HCPlotBulletStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotBulletStatesSelectAnimationOptions implements HCOption {
  const HCPlotBulletStatesSelectAnimationOptions({
    this.duration,
  });
