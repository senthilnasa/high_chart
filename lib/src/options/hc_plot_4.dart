...
class HCPlotBulletTargetOptions implements HCOption {
  const HCPlotBulletTargetOptions({
    this.borderColor,
    this.borderRadius,
    this.borderWidth,
    this.color,
  ...
  /// (Highcharts) The border color of the rectangle representing the target. When not set, the point's border color is used.
  ...
  /// (Highcharts) The color of the rectangle representing the target. When not set, point's color (if set in point's options - `color`) or zone of the target value (if `zones` or `negativeColor` are set) or the same color as the point has is used.
  final dynamic color;

  /// (Highcharts) The height of the rectangle representing the target.
  final num? height;

  /// (Highcharts) The width of the rectangle representing the target. Could be set as a pixel value or as a percentage of a column width.
  final dynamic width;
...
class HCPlotBulletTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotBulletTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotBulletTooltipHeaderOptions implements HCOption {
  const HCPlotBulletTooltipHeaderOptions({
...
class HCPlotBulletTooltipPositionOptions implements HCOption {
  const HCPlotBulletTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotCandlestickAccessibilityPointOptions implements HCOption {
  const HCPlotCandlestickAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
class HCPlotCandlestickDataLabelsAnimationOptions implements HCOption {
  const HCPlotCandlestickDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotCandlestickDataLabelsOptions implements HCOption {
  const HCPlotCandlestickDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotCandlestickDataSortingOptions implements HCOption {
  const HCPlotCandlestickDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotCandlestickLabelStyleOptions implements HCOption {
  const HCPlotCandlestickLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotCandlestickOnPointConnectorOptions implements HCOption {
  const HCPlotCandlestickOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotCandlestickOnPointOptions implements HCOption {
  const HCPlotCandlestickOnPointOptions({
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotCandlestickOnPointPositionOptions implements HCOption {
  const HCPlotCandlestickOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotCandlestickOptions implements HCOption {
  const HCPlotCandlestickOptions({
    this.accessibility,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotCandlestickDataSortingOptions? dataSorting;
  ...
  /// (Highstock) What type of legend symbol to render for this series. For candlestick series, the default is `candlestick`, a vertical line (wick) with a rectangular body.
  ...
  /// (Highstock) The pixel width of the candlestick line/border. Defaults to `1`.
  final num? lineWidth;
  ...
  /// (Highstock) The Y axis value to serve as the base for the columns, for distinguishing between values above and below a threshold. If `null`, the columns extend from the padding Y axis minimum.
  final num? threshold;
  ...
  /// (Highstock) The specific line color for up candle sticks. The default is to inherit the general `lineColor` setting.
...
class HCPlotCandlestickStatesHoverAnimationOptions implements HCOption {
  const HCPlotCandlestickStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotCandlestickStatesInactiveAnimationOptions implements HCOption {
  const HCPlotCandlestickStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCandlestickStatesSelectAnimationOptions implements HCOption {
  const HCPlotCandlestickStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotCandlestickTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotCandlestickTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotCandlestickTooltipHeaderOptions implements HCOption {
  const HCPlotCandlestickTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotCandlestickTooltipPositionOptions implements HCOption {
  const HCPlotCandlestickTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotCciAccessibilityPointOptions implements HCOption {
  const HCPlotCciAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotCciDataLabelsAnimationOptions implements HCOption {
  const HCPlotCciDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotCciDataLabelsOptions implements HCOption {
  const HCPlotCciDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotCciDataSortingOptions implements HCOption {
  const HCPlotCciDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotCciLabelStyleOptions implements HCOption {
  const HCPlotCciLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotCciOnPointConnectorOptions implements HCOption {
  const HCPlotCciOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotCciOnPointOptions implements HCOption {
  const HCPlotCciOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotCciOnPointPositionOptions implements HCOption {
  const HCPlotCciOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotCciOptions implements HCOption {
  const HCPlotCciOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotCciDataSortingOptions? dataSorting;
  ...
  final HCPlotCciParamsOptions? params;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotCciParamsOptions implements HCOption {
  const HCPlotCciParamsOptions({
    this.index,
    this.period,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCciStatesHoverAnimationOptions implements HCOption {
  const HCPlotCciStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCciStatesSelectAnimationOptions implements HCOption {
  const HCPlotCciStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotCciTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotCciTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotCciTooltipHeaderOptions implements HCOption {
  const HCPlotCciTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotCciTooltipPositionOptions implements HCOption {
  const HCPlotCciTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotChaikinAccessibilityPointOptions implements HCOption {
  const HCPlotChaikinAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotChaikinDataLabelsAnimationOptions implements HCOption {
  const HCPlotChaikinDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotChaikinDataLabelsOptions implements HCOption {
  const HCPlotChaikinDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotChaikinDataSortingOptions implements HCOption {
  const HCPlotChaikinDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotChaikinLabelStyleOptions implements HCOption {
  const HCPlotChaikinLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotChaikinMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotChaikinMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotChaikinOnPointConnectorOptions implements HCOption {
  const HCPlotChaikinOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotChaikinOnPointPositionOptions implements HCOption {
  const HCPlotChaikinOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotChaikinOptions implements HCOption {
  const HCPlotChaikinOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotChaikinDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Parameters used in calculation of Chaikin Oscillator series points.
  final HCPlotChaikinParamsOptions? params;
...
class HCPlotChaikinParamsOptions implements HCOption {
  ...
  /// (Highstock) Parameter used indirectly for calculating the `AD` indicator. Decides about the number of data points that are taken into account for the indicator calculations.
  final num? period;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotChaikinStatesHoverAnimationOptions implements HCOption {
  const HCPlotChaikinStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotChaikinStatesSelectAnimationOptions implements HCOption {
  const HCPlotChaikinStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotChaikinTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotChaikinTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotChaikinTooltipHeaderOptions implements HCOption {
  const HCPlotChaikinTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotChaikinTooltipPositionOptions implements HCOption {
  const HCPlotChaikinTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotCmfAccessibilityPointOptions implements HCOption {
  const HCPlotCmfAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotCmfDataLabelsAnimationOptions implements HCOption {
  const HCPlotCmfDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotCmfDataLabelsOptions implements HCOption {
  const HCPlotCmfDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotCmfDataSortingOptions implements HCOption {
  const HCPlotCmfDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotCmfLabelStyleOptions implements HCOption {
  const HCPlotCmfLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotCmfMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotCmfMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotCmfOnPointConnectorOptions implements HCOption {
  const HCPlotCmfOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotCmfOnPointOptions implements HCOption {
  const HCPlotCmfOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotCmfOnPointPositionOptions implements HCOption {
  const HCPlotCmfOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotCmfOptions implements HCOption {
  const HCPlotCmfOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.boostBlending,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotCmfDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Parameters used in calculation of regression series' points.
  final HCPlotCmfParamsOptions? params;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCmfStatesHoverAnimationOptions implements HCOption {
  const HCPlotCmfStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotCmfStatesInactiveAnimationOptions implements HCOption {
  const HCPlotCmfStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCmfStatesSelectAnimationOptions implements HCOption {
  const HCPlotCmfStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotCmfTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotCmfTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotCmfTooltipHeaderOptions implements HCOption {
  const HCPlotCmfTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotCmfTooltipPositionOptions implements HCOption {
  const HCPlotCmfTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotCmoAccessibilityPointOptions implements HCOption {
  const HCPlotCmoAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotCmoDataLabelsAnimationOptions implements HCOption {
  const HCPlotCmoDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotCmoDataLabelsOptions implements HCOption {
  const HCPlotCmoDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotCmoDataSortingOptions implements HCOption {
  const HCPlotCmoDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotCmoLabelStyleOptions implements HCOption {
  const HCPlotCmoLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotCmoMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotCmoMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotCmoOnPointConnectorOptions implements HCOption {
  const HCPlotCmoOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotCmoOnPointOptions implements HCOption {
  const HCPlotCmoOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotCmoOnPointPositionOptions implements HCOption {
  const HCPlotCmoOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotCmoOptions implements HCOption {
  const HCPlotCmoOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotCmoDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Parameters used in calculation of regression series' points.
  final HCPlotCmoParamsOptions? params;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotCmoParamsOptions implements HCOption {
  const HCPlotCmoParamsOptions({
    this.index,
    this.period,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCmoStatesHoverAnimationOptions implements HCOption {
  const HCPlotCmoStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotCmoStatesInactiveAnimationOptions implements HCOption {
  const HCPlotCmoStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCmoStatesSelectAnimationOptions implements HCOption {
  const HCPlotCmoStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotCmoTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotCmoTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotCmoTooltipHeaderOptions implements HCOption {
  const HCPlotCmoTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotCmoTooltipPositionOptions implements HCOption {
  const HCPlotCmoTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotColumnAccessibilityPointOptions implements HCOption {
  const HCPlotColumnAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotColumnDataLabelsAnimationOptions implements HCOption {
  const HCPlotColumnDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotColumnDataLabelsOptions implements HCOption {
  const HCPlotColumnDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotColumnDataSortingOptions implements HCOption {
  const HCPlotColumnDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotColumnLabelStyleOptions implements HCOption {
  const HCPlotColumnLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotColumnOnPointConnectorOptions implements HCOption {
  const HCPlotColumnOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotColumnOnPointOptions implements HCOption {
  const HCPlotColumnOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotColumnOnPointPositionOptions implements HCOption {
  const HCPlotColumnOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotColumnOptions implements HCOption {
  const HCPlotColumnOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotColumnDataSortingOptions? dataSorting;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotColumnStatesHoverAnimationOptions implements HCOption {
  const HCPlotColumnStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotColumnStatesSelectAnimationOptions implements HCOption {
  const HCPlotColumnStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotColumnTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotColumnTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
