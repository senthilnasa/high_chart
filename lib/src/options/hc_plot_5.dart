...
class HCPlotColumnTooltipPositionOptions implements HCOption {
  const HCPlotColumnTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotColumnpyramidAccessibilityPointOptions implements HCOption {
  const HCPlotColumnpyramidAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
class HCPlotColumnpyramidDataLabelsAnimationOptions implements HCOption {
  const HCPlotColumnpyramidDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotColumnpyramidDataLabelsOptions implements HCOption {
  const HCPlotColumnpyramidDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotColumnpyramidDataSortingOptions implements HCOption {
  const HCPlotColumnpyramidDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotColumnpyramidLabelStyleOptions implements HCOption {
  const HCPlotColumnpyramidLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotColumnpyramidOnPointConnectorOptions implements HCOption {
  const HCPlotColumnpyramidOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotColumnpyramidOnPointOptions implements HCOption {
  const HCPlotColumnpyramidOnPointOptions({
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotColumnpyramidOnPointPositionOptions implements HCOption {
  const HCPlotColumnpyramidOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotColumnpyramidOptions implements HCOption {
  const HCPlotColumnpyramidOptions({
    this.accessibility,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotColumnpyramidDataSortingOptions? dataSorting;
...
class HCPlotColumnpyramidStatesHoverAnimationOptions implements HCOption {
  const HCPlotColumnpyramidStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotColumnpyramidStatesSelectAnimationOptions implements HCOption {
  const HCPlotColumnpyramidStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotColumnpyramidTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotColumnpyramidTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotColumnpyramidTooltipHeaderOptions implements HCOption {
  const HCPlotColumnpyramidTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts, Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotColumnpyramidTooltipPositionOptions implements HCOption {
  const HCPlotColumnpyramidTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts, Highstock) Point accessibility options for a series.
class HCPlotColumnrangeAccessibilityPointOptions implements HCOption {
  const HCPlotColumnrangeAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotColumnrangeDataSortingOptions implements HCOption {
  const HCPlotColumnrangeDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotColumnrangeLabelStyleOptions implements HCOption {
  const HCPlotColumnrangeLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts, Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotColumnrangeOnPointConnectorOptions implements HCOption {
  const HCPlotColumnrangeOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotColumnrangeOptions implements HCOption {
  ...
  /// (Highcharts, Highstock) Extended data labels for range series types. Range series data labels have no `x` and `y` options. Instead, they have `xLow`, `xHigh`, `yLow` and `yHigh` options to allow the higher and lower data label sets individually.
  final dynamic dataLabels;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotColumnrangeStatesHoverAnimationOptions implements HCOption {
  const HCPlotColumnrangeStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotColumnrangeStatesSelectAnimationOptions implements HCOption {
  const HCPlotColumnrangeStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotColumnrangeTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotColumnrangeTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts, Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotColumnrangeTooltipHeaderOptions implements HCOption {
  const HCPlotColumnrangeTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts, Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotColumnrangeTooltipPositionOptions implements HCOption {
  const HCPlotColumnrangeTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotContourDataLabelsAnimationOptions implements HCOption {
  const HCPlotContourDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotContourDataLabelsOptions implements HCOption {
  const HCPlotContourDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotContourDataSortingOptions implements HCOption {
  const HCPlotContourDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotContourLabelStyleOptions implements HCOption {
  const HCPlotContourLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotContourMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotContourMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotContourOnPointConnectorOptions implements HCOption {
  const HCPlotContourOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotContourOnPointOptions implements HCOption {
  const HCPlotContourOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts, Highmaps) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotContourOnPointPositionOptions implements HCOption {
  const HCPlotContourOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotContourOptions implements HCOption {
  ...
  /// (Highcharts, Highmaps) Set the point threshold for when a series should enter boost mode.
  final num? boostThreshold;
  ...
  /// (Highcharts, Highmaps) The main color of the series. In line type series it applies to the line and the point markers unless otherwise specified. In bar type series it applies to the bars unless a color is specified per point. The default value is pulled from the `options.colors` array.
  final dynamic color;
  ...
  /// (Highcharts, Highstock, Highmaps) This must be set to `'value'` to make the colorAxis track with the contour plot.
  final String? colorKey;

  /// (Highcharts, Highmaps) The interval between contour lines. Determines the spacing of value levels where lines are drawn on the plot. By default, the interval is calculated using the value range.
  final num? contourInterval;

  /// (Highcharts, Highmaps) The offset for contour line positioning. Shifts the contour levels so lines and bands are drawn at `contourOffset + n * contourInterval` instead of `n * contourInterval`.
  ...
  /// (Highcharts, Highmaps) Determines whether the series should look for the nearest point in both dimensions or just the x-dimension when hovering the series. Defaults to `'xy'` for scatter series and `'x'` for most other series. If the data has duplicate x-values, it is recommended to set this to `'xy
  final String? findNearestPointBy;
  ...
  /// (Highcharts, Highstock) This setting controls the visibility and size of contour lines. For now, only '1' and '0' are valid options, effectively controlling the visibility of the lines.
  final num? lineWidth;

  /// (Highcharts, Highstock, Gantt) The id of another series to link to. Additionally, the value can be ":previous" to link to the previous series. When two series are linked, only the first one appears in the legend. Toggling the visibility of this also toggles the linked series.
  final String? linkedTo;

  /// (Highcharts, Highmaps) Options for the point markers of line and scatter-like series. Properties like `fillColor`, `lineColor` and `lineWidth` define the visual appearance of the markers. The `symbol` option defines the shape. Other series types, like column series, don't have markers, but have visu
  ...
  /// (Highcharts, Highmaps) Whether to use gradually transitioning color gradients between contour levels. When disabled, each contour level is filled with a single flat color.
  final bool? smoothColoring;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (smoothColoring != null) {
      json['smoothColoring'] = smoothColoring;
    }
    if (sonification != null) {
      json['sonification'] = sonification!.toJson();
    }
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotContourStatesHoverAnimationOptions implements HCOption {
  const HCPlotContourStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotContourStatesInactiveAnimationOptions implements HCOption {
  const HCPlotContourStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotContourStatesSelectAnimationOptions implements HCOption {
  const HCPlotContourStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotContourTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotContourTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotContourTooltipPositionOptions implements HCOption {
  const HCPlotContourTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotCylinderAccessibilityPointOptions implements HCOption {
  const HCPlotCylinderAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotCylinderDataLabelsAnimationOptions implements HCOption {
  const HCPlotCylinderDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotCylinderDataLabelsOptions implements HCOption {
  const HCPlotCylinderDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotCylinderDataSortingOptions implements HCOption {
  const HCPlotCylinderDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotCylinderLabelStyleOptions implements HCOption {
  const HCPlotCylinderLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotCylinderOnPointConnectorOptions implements HCOption {
  const HCPlotCylinderOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotCylinderOnPointOptions implements HCOption {
  const HCPlotCylinderOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotCylinderOnPointPositionOptions implements HCOption {
  const HCPlotCylinderOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotCylinderOptions implements HCOption {
  const HCPlotCylinderOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotCylinderDataSortingOptions? dataSorting;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCylinderStatesHoverAnimationOptions implements HCOption {
  const HCPlotCylinderStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotCylinderStatesInactiveAnimationOptions implements HCOption {
  const HCPlotCylinderStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotCylinderStatesSelectAnimationOptions implements HCOption {
  const HCPlotCylinderStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotCylinderTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotCylinderTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotCylinderTooltipHeaderOptions implements HCOption {
  const HCPlotCylinderTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotCylinderTooltipPositionOptions implements HCOption {
  const HCPlotCylinderTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotDemaAccessibilityPointOptions implements HCOption {
  const HCPlotDemaAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotDemaDataLabelsOptions implements HCOption {
  const HCPlotDemaDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotDemaDataSortingOptions implements HCOption {
  const HCPlotDemaDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotDemaLabelStyleOptions implements HCOption {
  const HCPlotDemaLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotDemaMarkerStatesHoverAnimationOptions implements HCOption {
...
class HCPlotDemaOnPointConnectorOptions implements HCOption {
  const HCPlotDemaOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotDemaOnPointOptions implements HCOption {
  const HCPlotDemaOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotDemaOnPointPositionOptions implements HCOption {
  const HCPlotDemaOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotDemaOptions implements HCOption {
  const HCPlotDemaOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotDemaDataSortingOptions? dataSorting;
  ...
  final HCPlotDemaParamsOptions? params;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotDemaParamsOptions implements HCOption {
  const HCPlotDemaParamsOptions({
    this.index,
    this.period,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotDemaStatesHoverAnimationOptions implements HCOption {
  const HCPlotDemaStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotDemaStatesInactiveAnimationOptions implements HCOption {
  const HCPlotDemaStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotDemaStatesSelectAnimationOptions implements HCOption {
  const HCPlotDemaStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotDemaTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotDemaTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotDemaTooltipHeaderOptions implements HCOption {
  const HCPlotDemaTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotDemaTooltipPositionOptions implements HCOption {
  const HCPlotDemaTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highcharts) Point accessibility options for a series.
class HCPlotDependencywheelAccessibilityPointOptions implements HCOption {
  const HCPlotDependencywheelAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotDependencywheelDataLabelsAnimationOptions implements HCOption {
  const HCPlotDependencywheelDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotDependencywheelLabelStyleOptions implements HCOption {
  const HCPlotDependencywheelLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotDependencywheelLevelsDataLabelsAnimationOptions
    implements HCOption {
  const HCPlotDependencywheelLevelsDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotDependencywheelLevelsOptions implements HCOption {
  const HCPlotDependencywheelLevelsOptions({
    this.borderColor,
    this.borderWidth,
    this.color,
    this.colorByPoint,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotDependencywheelLevelsStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotDependencywheelLevelsStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotDependencywheelLevelsStatesSelectAnimationOptions
    implements HCOption {
  const HCPlotDependencywheelLevelsStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Options for the connector in the _Series on point_ feature.
class HCPlotDependencywheelOnPointConnectorOptions implements HCOption {
  const HCPlotDependencywheelOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highcharts) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotDependencywheelOnPointOptions implements HCOption {
  const HCPlotDependencywheelOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotDependencywheelOnPointPositionOptions implements HCOption {
  const HCPlotDependencywheelOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotDependencywheelOptions implements HCOption {
  ...
  /// (Highcharts) The corner radius of the border surrounding each node. A number signifies pixels. A percentage string, like for example `50%`, signifies a relative size. For nodes this is relative to the node width.
  final dynamic borderRadius;

  /// (Highcharts, Highstock, Gantt) The width of the border surrounding each column or bar. Defaults to `1` when there is room for a border, but to `0` when the columns are so dense that a border would cover the next column.
  final num? borderWidth;

  /// (Highcharts) The center of the wheel relative to the plot area. Can be percentages or pixel values. The default behavior is to center the wheel inside the plot area.
  ...
  /// (Highcharts) Size of the wheel in pixel or percent relative to the canvas space.
  final dynamic size;
  ...
  /// (Highcharts) The start angle of the dependency wheel, in degrees where 0 is up.
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotDependencywheelStatesHoverAnimationOptions implements HCOption {
  const HCPlotDependencywheelStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highcharts) Animation when not hovering over the marker.
class HCPlotDependencywheelStatesInactiveAnimationOptions implements HCOption {
  const HCPlotDependencywheelStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotDependencywheelStatesSelectAnimationOptions implements HCOption {
  const HCPlotDependencywheelStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotDependencywheelTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotDependencywheelTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highcharts) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotDependencywheelTooltipHeaderOptions implements HCOption {
  const HCPlotDependencywheelTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highcharts) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotDependencywheelTooltipPositionOptions implements HCOption {
  const HCPlotDependencywheelTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotDisparityindexAccessibilityPointOptions implements HCOption {
  const HCPlotDisparityindexAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotDisparityindexDataLabelsAnimationOptions implements HCOption {
  const HCPlotDisparityindexDataLabelsAnimationOptions({
    this.defer,
  });
