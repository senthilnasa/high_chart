...
class HCPlotItemTooltipPositionOptions implements HCOption {
  const HCPlotItemTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotKeltnerchannelsAccessibilityPointOptions implements HCOption {
  const HCPlotKeltnerchannelsAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
...
/// (Highstock) Styles for a bottom line.
class HCPlotKeltnerchannelsBottomLineStylesOptions implements HCOption {
  const HCPlotKeltnerchannelsBottomLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });

  /// (Highstock) Color of the line. If not set, it's inherited from `plotOptions.keltnerchannels.color`
...
class HCPlotKeltnerchannelsDataLabelsAnimationOptions implements HCOption {
  const HCPlotKeltnerchannelsDataLabelsAnimationOptions({
    this.defer,
  });
...
class HCPlotKeltnerchannelsDataLabelsOptions implements HCOption {
  const HCPlotKeltnerchannelsDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
class HCPlotKeltnerchannelsDataSortingOptions implements HCOption {
  const HCPlotKeltnerchannelsDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
class HCPlotKeltnerchannelsLabelStyleOptions implements HCOption {
  const HCPlotKeltnerchannelsLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotKeltnerchannelsMarkerStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotKeltnerchannelsMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotKeltnerchannelsOnPointConnectorOptions implements HCOption {
  const HCPlotKeltnerchannelsOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotKeltnerchannelsOnPointOptions implements HCOption {
  const HCPlotKeltnerchannelsOnPointOptions({
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotKeltnerchannelsOnPointPositionOptions implements HCOption {
  const HCPlotKeltnerchannelsOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotKeltnerchannelsOptions implements HCOption {
  const HCPlotKeltnerchannelsOptions({
    this.accessibility,
  ...
  /// (Highstock) Bottom line options.
  final HCPlotKeltnerchannelsBottomLineOptions? bottomLine;
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotKeltnerchannelsDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Option for fill color between lines in Keltner Channels Indicator.
  ...
  final HCPlotKeltnerchannelsParamsOptions? params;
  ...
  final HCPlotKeltnerchannelsTopLineOptions? topLine;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotKeltnerchannelsParamsOptions implements HCOption {
  const HCPlotKeltnerchannelsParamsOptions({
    this.index,
    this.period,
  });
...
class HCPlotKeltnerchannelsStatesHoverAnimationOptions implements HCOption {
...
class HCPlotKeltnerchannelsStatesInactiveAnimationOptions implements HCOption {
  const HCPlotKeltnerchannelsStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotKeltnerchannelsStatesSelectAnimationOptions implements HCOption {
  const HCPlotKeltnerchannelsStatesSelectAnimationOptions({
    this.duration,
  });
...
class HCPlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotKeltnerchannelsTooltipHeaderOptions implements HCOption {
  const HCPlotKeltnerchannelsTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
class HCPlotKeltnerchannelsTooltipPositionOptions implements HCOption {
  const HCPlotKeltnerchannelsTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Styles for a bottom line.
class HCPlotKeltnerchannelsTopLineStylesOptions implements HCOption {
  const HCPlotKeltnerchannelsTopLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });
...
/// (Highstock) Point accessibility options for a series.
class HCPlotKlingerAccessibilityPointOptions implements HCOption {
  const HCPlotKlingerAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotKlingerDataLabelsAnimationOptions implements HCOption {
  const HCPlotKlingerDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotKlingerDataLabelsOptions implements HCOption {
  const HCPlotKlingerDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotKlingerDataSortingOptions implements HCOption {
  const HCPlotKlingerDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotKlingerLabelStyleOptions implements HCOption {
  const HCPlotKlingerLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotKlingerMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotKlingerMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotKlingerOnPointConnectorOptions implements HCOption {
  const HCPlotKlingerOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotKlingerOnPointOptions implements HCOption {
  const HCPlotKlingerOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotKlingerOnPointPositionOptions implements HCOption {
  const HCPlotKlingerOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotKlingerOptions implements HCOption {
  const HCPlotKlingerOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotKlingerDataSortingOptions? dataSorting;
  ...
  final HCPlotKlingerParamsOptions? params;
  ...
  final HCPlotKlingerSignalLineOptions? signalLine;
...
class HCPlotKlingerParamsOptions implements HCOption {
  ...
  /// (Highstock) The id of another series to use its data as volume data for the indiator calculation.
...
/// (Highstock) Styles for a signal line.
class HCPlotKlingerSignalLineStylesOptions implements HCOption {
  const HCPlotKlingerSignalLineStylesOptions({
    this.lineColor,
    this.lineWidth,
  });

  /// (Highstock) Color of the line. If not set, it's inherited from plotOptions.klinger.color.
  final String? lineColor;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotKlingerStatesHoverAnimationOptions implements HCOption {
  const HCPlotKlingerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotKlingerStatesInactiveAnimationOptions implements HCOption {
  const HCPlotKlingerStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotKlingerStatesSelectAnimationOptions implements HCOption {
  const HCPlotKlingerStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotKlingerTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotKlingerTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotKlingerTooltipHeaderOptions implements HCOption {
  const HCPlotKlingerTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotKlingerTooltipPositionOptions implements HCOption {
  const HCPlotKlingerTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
class HCPlotLineAccessibilityPointOptions implements HCOption {
  const HCPlotLineAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotLineDataLabelsAnimationOptions implements HCOption {
  const HCPlotLineDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotLineDataLabelsOptions implements HCOption {
  const HCPlotLineDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotLineDataSortingOptions implements HCOption {
  const HCPlotLineDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotLineLabelStyleOptions implements HCOption {
  const HCPlotLineLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
class HCPlotLineMarkerStatesHoverAnimationOptions implements HCOption {
  const HCPlotLineMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotLineOnPointConnectorOptions implements HCOption {
  const HCPlotLineOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
class HCPlotLineOnPointOptions implements HCOption {
  const HCPlotLineOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highcharts, Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotLineOnPointPositionOptions implements HCOption {
  const HCPlotLineOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotLineOptions implements HCOption {
  const HCPlotLineOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotLineDataSortingOptions? dataSorting;
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLineStatesHoverAnimationOptions implements HCOption {
  const HCPlotLineStatesHoverAnimationOptions({
    this.duration,
  });
...
class HCPlotLineStatesInactiveAnimationOptions implements HCOption {
  const HCPlotLineStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLineStatesSelectAnimationOptions implements HCOption {
  const HCPlotLineStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotLineTooltipDateTimeLabelFormatsOptions implements HCOption {
  const HCPlotLineTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
class HCPlotLineTooltipHeaderOptions implements HCOption {
  const HCPlotLineTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotLinearregressionAccessibilityPointOptions implements HCOption {
  const HCPlotLinearregressionAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotLinearregressionDataLabelsAnimationOptions implements HCOption {
  const HCPlotLinearregressionDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotLinearregressionDataLabelsOptions implements HCOption {
  const HCPlotLinearregressionDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotLinearregressionDataSortingOptions implements HCOption {
  const HCPlotLinearregressionDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotLinearregressionLabelStyleOptions implements HCOption {
  const HCPlotLinearregressionLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotLinearregressionOnPointConnectorOptions implements HCOption {
  const HCPlotLinearregressionOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotLinearregressionOnPointOptions implements HCOption {
  const HCPlotLinearregressionOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotLinearregressionOnPointPositionOptions implements HCOption {
  const HCPlotLinearregressionOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLinearregressionStatesHoverAnimationOptions implements HCOption {
  const HCPlotLinearregressionStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotLinearregressionStatesInactiveAnimationOptions implements HCOption {
  const HCPlotLinearregressionStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLinearregressionStatesSelectAnimationOptions implements HCOption {
  const HCPlotLinearregressionStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotLinearregressionTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotLinearregressionTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotLinearregressionTooltipPositionOptions implements HCOption {
  const HCPlotLinearregressionTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotLinearregressionangleAccessibilityPointOptions implements HCOption {
  const HCPlotLinearregressionangleAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotLinearregressionangleDataLabelsAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionangleDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotLinearregressionangleDataLabelsOptions implements HCOption {
  const HCPlotLinearregressionangleDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotLinearregressionangleDataSortingOptions implements HCOption {
  const HCPlotLinearregressionangleDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotLinearregressionangleLabelStyleOptions implements HCOption {
  const HCPlotLinearregressionangleLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotLinearregressionangleMarkerStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionangleMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotLinearregressionangleOnPointConnectorOptions implements HCOption {
  const HCPlotLinearregressionangleOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotLinearregressionangleOnPointOptions implements HCOption {
  const HCPlotLinearregressionangleOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotLinearregressionangleOnPointPositionOptions implements HCOption {
  const HCPlotLinearregressionangleOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
...
class HCPlotLinearregressionangleOptions implements HCOption {
  const HCPlotLinearregressionangleOptions({
    this.accessibility,
    this.allowPointSelect,
    this.animation,
    this.animationLimit,
  ...
  /// (Highcharts, Highstock) Options for series data sorting.
  final HCPlotLinearregressionangleDataSortingOptions? dataSorting;
  ...
  /// (Highstock) Parameters used in calculation of regression series' points.
  final HCPlotLinearregressionangleParamsOptions? params;
...
/// (Highstock) Parameters used in calculation of regression series' points.
class HCPlotLinearregressionangleParamsOptions implements HCOption {
  const HCPlotLinearregressionangleParamsOptions({
    this.index,
    this.period,
    this.xAxisUnit,
  });
...
/// (Highstock) Animation when not hovering over the marker.
class HCPlotLinearregressionangleStatesInactiveAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionangleStatesInactiveAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock) Animation setting for hovering the graph in line-type series.
class HCPlotLinearregressionangleStatesSelectAnimationOptions
    implements HCOption {
  const HCPlotLinearregressionangleStatesSelectAnimationOptions({
    this.duration,
  });
...
/// (Highcharts, Highstock, Gantt) For series on datetime axes, the date format in the tooltip's header will by default be guessed based on the closest data points. This member gives the default string representations used for each unit. For an overview of the string or object configuration, see dateFor
class HCPlotLinearregressionangleTooltipDateTimeLabelFormatsOptions
    implements HCOption {
  const HCPlotLinearregressionangleTooltipDateTimeLabelFormatsOptions({
    this.day,
    this.hour,
    this.millisecond,
    this.minute,
...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The header is the box containing the X value in a split tooltip.
class HCPlotLinearregressionangleTooltipHeaderOptions implements HCOption {
  const HCPlotLinearregressionangleTooltipHeaderOptions({
    this.backgroundColor,
    this.borderColor,
    this.borderWidth,
    this.distance,
...
/// (Highstock) Positioning options for fixed tooltip, taking effect only when tooltip.fixed is `true`.
class HCPlotLinearregressionangleTooltipPositionOptions implements HCOption {
  const HCPlotLinearregressionangleTooltipPositionOptions({
    this.align,
    this.relativeTo,
    this.verticalAlign,
    this.x,
...
/// (Highstock) Point accessibility options for a series.
class HCPlotLinearregressioninterceptAccessibilityPointOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptAccessibilityPointOptions({
    this.dateFormat,
    this.describeNull,
    this.descriptionFormat,
    this.valueDecimals,
...
/// (Highcharts, Highstock, Highmaps, Gantt) Enable or disable the initial animation when a series is displayed for the `dataLabels`. The animation can also be set as a configuration object. Please note that this option only applies to the initial animation.
class HCPlotLinearregressioninterceptDataLabelsAnimationOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptDataLabelsAnimationOptions({
    this.defer,
  });
...
/// (Highcharts, Highstock, Highmaps, Gantt) Options for the series data labels, appearing next to each data point.
class HCPlotLinearregressioninterceptDataLabelsOptions implements HCOption {
  const HCPlotLinearregressioninterceptDataLabelsOptions({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
...
/// (Highcharts, Highstock) Options for series data sorting.
class HCPlotLinearregressioninterceptDataSortingOptions implements HCOption {
  const HCPlotLinearregressioninterceptDataSortingOptions({
    this.enabled,
    this.matchByName,
    this.sortKey,
  });
...
/// (Highcharts, Highstock, Gantt) Styles for the series label. The color defaults to the series color, or a contrast color if `onArea`.
class HCPlotLinearregressioninterceptLabelStyleOptions implements HCOption {
  const HCPlotLinearregressioninterceptLabelStyleOptions({
    this.fontSize,
    this.fontWeight,
  });
...
/// (Highstock) Animation when hovering over the marker.
class HCPlotLinearregressioninterceptMarkerStatesHoverAnimationOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptMarkerStatesHoverAnimationOptions({
    this.duration,
  });
...
/// (Highstock) Options for the connector in the _Series on point_ feature.
class HCPlotLinearregressioninterceptOnPointConnectorOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptOnPointConnectorOptions({
    this.dashstyle,
    this.stroke,
    this.width,
  });
...
/// (Highstock) Options for the _Series on point_ feature. Only `pie` and `sunburst` series are supported at this moment.
class HCPlotLinearregressioninterceptOnPointOptions implements HCOption {
  const HCPlotLinearregressioninterceptOnPointOptions({
    this.connectorOptions,
    this.id,
    this.position,
  });
...
/// (Highstock) Options allowing to set a position and an offset of the series in the _Series on point_ feature.
class HCPlotLinearregressioninterceptOnPointPositionOptions
    implements HCOption {
  const HCPlotLinearregressioninterceptOnPointPositionOptions({
    this.offsetX,
    this.offsetY,
    this.x,
    this.y,
