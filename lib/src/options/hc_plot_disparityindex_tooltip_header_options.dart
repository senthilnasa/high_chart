...
/// (Highstock) Options for the tooltip header when tooltip.split is enabled. The
class HCPlotDisparityindexTooltipHeaderOptions implements HCOption {
  const HCPlotDisparityindexTooltipHeaderOptions({
  ...
  /// (Highstock) Background color for the tooltip header when tooltip.split is
