...
class HCPlotTreegraphLevelsOptions implements HCOption {
  const HCPlotTreegraphLevelsOptions({
    this.borderColor,
  ...
  final HCPlotTreegraphLevelsColorVariationOptions? colorVariation;
