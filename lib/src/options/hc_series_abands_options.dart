...
class HCSeriesAbandsOptions implements HCOption {
  const HCSeriesAbandsOptions({
    this.allAreas,
    this.dataParser,
    this.dataURL,
    this.type,
  ...
  final HCPlotAbandsBottomLineOptions? bottomLine;
  ...
  final HCPlotAbandsDataSortingOptions? dataSorting;
  ...
  final HCPlotAbandsParamsOptions? params;
  ...
  final HCPlotAbandsTopLineOptions? topLine;
