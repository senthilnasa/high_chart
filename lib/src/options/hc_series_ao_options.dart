...
class HCSeriesAoOptions implements HCOption {
  const HCSeriesAoOptions({
    this.allAreas,
    this.dataParser,
    this.dataURL,
    this.type,
  ...
  final HCPlotAoDataSortingOptions? dataSorting;
  ...
  final HCPlotAoParamsOptions? params;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (greaterBarColor != null) {
      json["greaterBarColor"] = hcJsonValue(greaterBarColor);
    }
    ...
    if (lowerBarColor != null) {
      json["lowerBarColor"] = hcJsonValue(lowerBarColor);
    }
    if (marker != null) {
