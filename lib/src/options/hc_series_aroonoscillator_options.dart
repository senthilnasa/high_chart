...
class HCSeriesAroonoscillatorOptions implements HCOption {
  const HCSeriesAroonoscillatorOptions({
    this.allAreas,
    this.aroonDown,
    this.dataParser,
    this.dataURL,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (aroonDown != null) {
      json["aroonDown"] = hcJsonValue(aroonDown);
    }
    if (dataParser != null) {
