...
class HCSeriesDisparityindexOptions implements HCOption {
  const HCSeriesDisparityindexOptions({
    this.allAreas,
    this.dataParser,
    this.dataURL,
    this.type,
  ...
  final HCPlotDisparityindexDataSortingOptions? dataSorting;
  ...
  final HCPlotDisparityindexParamsOptions? params;
