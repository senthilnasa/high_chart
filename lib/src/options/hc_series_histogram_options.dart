...
class HCSeriesHistogramOptions implements HCOption {
  const HCSeriesHistogramOptions({
    this.baseSeries,
    this.data,
    this.dataParser,
    this.dataURL,
  ...
  final HCPlotHistogramDataSortingOptions? dataSorting;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (binsNumber != null) {
      json["binsNumber"] = hcJsonValue(binsNumber);
    }
    if (binWidth != null) {
    ...
    if (pointPlacement != null) {
      json["pointPlacement"] = pointPlacement;
    }
    if (pointRange != null) {
