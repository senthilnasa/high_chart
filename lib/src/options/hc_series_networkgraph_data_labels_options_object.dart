...
class HCSeriesNetworkgraphDataLabelsOptionsObject implements HCOption {
  const HCSeriesNetworkgraphDataLabelsOptionsObject({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (linkFormatter != null) {
      json["linkFormatter"] = hcJsonValue(linkFormatter);
    }
