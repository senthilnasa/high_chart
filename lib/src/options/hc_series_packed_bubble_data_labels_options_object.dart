...
class HCSeriesPackedBubbleDataLabelsOptionsObject implements HCOption {
  const HCSeriesPackedBubbleDataLabelsOptionsObject({
    this.align,
    this.alignTo,
    this.allowOverlap,
    this.animation,
  ...
  final String? parentNodeFormat;

  final dynamic parentNodeFormatter;

  final HCSeriesPackedBubbleDataLabelsTextPathOptionsObject? parentNodeTextPath;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (parentNodeFormat != null) {
      json["parentNodeFormat"] = parentNodeFormat;
    }
    if (parentNodeFormatter != null) {
      json["parentNodeFormatter"] = hcJsonValue(parentNodeFormatter);
    }
    if (parentNodeTextPath != null) {
      json["parentNodeTextPath"] = parentNodeTextPath!.toJson();
    }
    if (position != null) {
