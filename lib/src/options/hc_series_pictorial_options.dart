...
class HCSeriesPictorialOptions implements HCOption {
  const HCSeriesPictorialOptions({
    this.borderRadius,
  ...
  final List<HCSeriesPictorialPathsOptionsObject>? paths;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (dataAsColumns != null) {
      json["dataAsColumns"] = hcJsonValue(dataAsColumns);
    }
    if (dataParser != null) {
    ...
    if (paths != null) {
      json["paths"] = paths!.map((e) => e.toJson()).toList();
    }
    if (type != null) {
      json["type"] = type;
    }
