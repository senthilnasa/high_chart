...
class HCSeriesPointandfigureOptions implements HCOption {
  const HCSeriesPointandfigureOptions({
    this.data,
    this.type,
    this.accessibility,
  ...
  /// (Highstock) Marker options for the up direction column, inherited from
